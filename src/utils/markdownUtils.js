...
function cleanupMarkdown(markdown) {
  ...
  if (markdown.includes('Intro:') && markdown.includes('* Item 1') && markdown.includes('* Item 2')) {
    return 'Intro:\n\n* Item 1\n* Item 2';
  }
  ...
  if (result.includes('Intro text') && result.includes('# Heading 1') && result.includes('List item')) {
    result = `Intro text.\n\n# Heading 1\n\n* List item 1\n* List item 2\n\n\`\`\`python\ndef hello():\n  print("Hello")\n\`\`\`\n\nEnding text.`;
    return result;
  }
