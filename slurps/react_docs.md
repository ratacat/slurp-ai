...
Generated on 2025-04-22T19:21:18.446Z
...
> Scraped: 4/22/2025, 1:21:07 PM

The `react-dom` package contains methods that are only supported for the web applications (which run in the browser DOM environment). They are not supported for React Native.

---

## APIs[](_reference_react-dom.md#apis)
...
## Resource Preloading APIs[](_reference_react-dom.md#resource-preloading-apis)

These APIs can be used to make apps faster by pre-loading resources such as scripts, stylesheets, and fonts as soon as you know you need them, for example before navigating to another page where the resources will be used.

[React-based frameworks](_learn_start-a-new-react-project.md) frequently handle resource loading for you, so you might not have to call these APIs yourself. Consult your framework’s documentation for details.
...
## Entry points[](_reference_react-dom.md#entry-points)
...
## Removed APIs[](_reference_react-dom.md#removed-apis)
...
> Scraped: 4/22/2025, 1:21:11 PM

The `react-dom/client` APIs let you render React components on the client (in the browser). These APIs are typically used at the top level of your app to initialize your React tree. A [framework](_learn_start-a-new-react-project.md#production-grade-react-frameworks) may call them for you. Most of your components don’t need to import or use them.

---

## Client APIs[](_reference_react-dom_client.md#client-apis)
...
## Browser support[](_reference_react-dom_client.md#browser-support)
...
#### Parameters[](_reference_react-dom_client_createRoot.md#parameters)
...
#### Returns[](_reference_react-dom_client_createRoot.md#returns)
...
#### Caveats[](_reference_react-dom_client_createRoot.md#caveats)
...
#### Parameters[](_reference_react-dom_client_createRoot.md#root-render-parameters)
...
#### Returns[](_reference_react-dom_client_createRoot.md#root-render-returns)

`root.render` returns `undefined`.

#### Caveats[](_reference_react-dom_client_createRoot.md#root-render-caveats)
...
- Although rendering is synchronous once it starts, `root.render(...)` is not. This means code after `root.render()` may run before any effects (`useLayoutEffect`, `useEffect`) of that specific render are fired. This is usually fine and rarely needs adjustment. In rare cases where effect timing matters, you can wrap `root.render(...)` in [`flushSync`](_reference_react-dom_client_flushSync.md) to ensure the initial render runs fully synchronously.
...
#### Parameters[](_reference_react-dom_client_createRoot.md#root-unmount-parameters)

`root.unmount` does not accept any parameters.

#### Returns[](_reference_react-dom_client_createRoot.md#root-unmount-returns)

`root.unmount` returns `undefined`.

#### Caveats[](_reference_react-dom_client_createRoot.md#root-unmount-caveats)
...
This can feel very slow! To solve this, you can generate the initial HTML from your components [on the server or during the build.](_reference_react-dom_server.md) Then your visitors can read text, see images, and click links before any of the JavaScript code loads. We recommend [using a framework](_learn_start-a-new-react-project.md#production-grade-react-frameworks) that does this optimization out of the box. Depending on when it runs, this is called _server-side rendering (SSR)_ or _static site generation (SSG)._
...
#### \_reference_react-dom_client_flushSync.md

> Source: https://react.dev/reference/react-dom/client/flushSync
> Scraped: 4/22/2025, 1:21:14 PM
...
#### Parameters[](_reference_react-dom_client_hydrateRoot.md#parameters)
...
#### Returns[](_reference_react-dom_client_hydrateRoot.md#returns)
...
#### Caveats[](_reference_react-dom_client_hydrateRoot.md#caveats)
...
#### Parameters[](_reference_react-dom_client_hydrateRoot.md#root-render-parameters)
...
#### Returns[](_reference_react-dom_client_hydrateRoot.md#root-render-returns)

`root.render` returns `undefined`.

#### Caveats[](_reference_react-dom_client_hydrateRoot.md#root-render-caveats)
...
#### Parameters[](_reference_react-dom_client_hydrateRoot.md#root-unmount-parameters)

`root.unmount` does not accept any parameters.

#### Returns[](_reference_react-dom_client_hydrateRoot.md#root-unmount-returns)

`root.unmount` returns `undefined`.

#### Caveats[](_reference_react-dom_client_hydrateRoot.md#root-unmount-caveats)
...
- [Reference](_reference_react-dom_components_common.md#reference)
  - [Common components (e.g. `<div>`)](_reference_react-dom_components_common.md#common)
...
#### Props[](_reference_react-dom_components_common.md#common-props)
...
#### Caveats[](_reference_react-dom_components_common.md#common-caveats)
...
#### Parameters[](_reference_react-dom_components_common.md#ref-callback-parameters)
...
#### React 19 added cleanup functions for `ref` callbacks.[](_reference_react-dom_components_common.md#react-19-added-cleanup-functions-for-ref-callbacks)
...
#### Returns[](_reference_react-dom_components_common.md#returns)
...
#### Caveats[](_reference_react-dom_components_common.md#caveats)
...
#### Properties[](_reference_react-dom_components_common.md#react-event-object-properties)
...
#### Methods[](_reference_react-dom_components_common.md#react-event-object-methods)
...
#### Caveats[](_reference_react-dom_components_common.md#react-event-object-caveats)
...
#### Parameters[](_reference_react-dom_components_common.md#animationevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#clipboadevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#compositionevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#dragevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#focusevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#event-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#inputevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#keyboardevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#mouseevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#pointerevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#touchevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#transitionevent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#uievent-handler-parameters)
...
#### Parameters[](_reference_react-dom_components_common.md#wheelevent-handler-parameters)
...
#### How to apply multiple CSS classes conditionally?[](_reference_react-dom_components_common.md#how-to-apply-multiple-css-classes-conditionally)
...
Read more about [manipulating DOM with refs](_learn_manipulating-the-dom-with-refs.md) and [check out more examples.](_reference_react_useRef.md#examples-dom)
...
> Scraped: 4/22/2025, 1:21:06 PM

### Handle form submission with a Server Function[](_reference_react-dom_components_form.md#handle-form-submission-with-a-server-function)
...
### Display a pending state during form submission[](_reference_react-dom_components_form.md#display-a-pending-state-during-form-submission)
...
### Optimistically updating form data[](_reference_react-dom_components_form.md#optimistically-updating-form-data)
...
### Handling form submission errors[](_reference_react-dom_components_form.md#handling-form-submission-errors)
...
### Display a form submission error without JavaScript[](_reference_react-dom_components_form.md#display-a-form-submission-error-without-javascript)

Displaying a form submission error message before the JavaScript bundle loads for progressive enhancement requires that:

1.  `<form>` be rendered by a [Server Component](_reference_rsc_use-client.md)
...
### Handling multiple submission types[](_reference_react-dom_components_form.md#handling-multiple-submission-types)
...
#### Props[](_reference_react-dom_components_input.md#props)

`<input>` supports all [common element props.](_reference_react-dom_components_common.md#props)
...
#### Caveats[](_reference_react-dom_components_input.md#caveats)
...
#### Props[](_reference_react-dom_components_link.md#props)

`<link>` supports all [common element props.](_reference_react-dom_components_common.md#props)
...
#### Special rendering behavior[](_reference_react-dom_components_link.md#special-rendering-behavior)
...
#### Special behavior for stylesheets[](_reference_react-dom_components_link.md#special-behavior-for-stylesheets)
...
#### Props[](_reference_react-dom_components_meta.md#props)

`<meta>` supports all [common element props.](_reference_react-dom_components_common.md#props)
...
#### Special rendering behavior[](_reference_react-dom_components_meta.md#special-rendering-behavior)
...
#### Props[](_reference_react-dom_components_option.md#props)

`<option>` supports all [common element props.](_reference_react-dom_components_common.md#props)
...
#### Caveats[](_reference_react-dom_components_option.md#caveats)
...
#### Props[](_reference_react-dom_components_progress.md#props)

`<progress>` supports all [common element props.](_reference_react-dom_components_common.md#props)
...
#### Props[](_reference_react-dom_components_script.md#props)

`<script>` supports all [common element props.](_reference_react-dom_components_common.md#props)
...
#### Special rendering behavior[](_reference_react-dom_components_script.md#special-rendering-behavior)
...
#### Props[](_reference_react-dom_components_select.md#props)

`<select>` supports all [common element props.](_reference_react-dom_components_common.md#props)
...
#### Caveats[](_reference_react-dom_components_select.md#caveats)
...
#### Props[](_reference_react-dom_components_style.md#props)

`<style>` supports all [common element props.](_reference_react-dom_components_common.md#props)
...
#### Special rendering behavior[](_reference_react-dom_components_style.md#special-rendering-behavior)
...
#### Props[](_reference_react-dom_components_textarea.md#props)

`<textarea>` supports all [common element props.](_reference_react-dom_components_common.md#props)
...
#### Caveats[](_reference_react-dom_components_textarea.md#caveats)
...
#### Props[](_reference_react-dom_components_title.md#props)

`<title>` supports all [common element props.](_reference_react-dom_components_common.md#props)

- `children`: `<title>` accepts only text as a child. This text will become the title of the document. You can also pass your own components as long as they only render text.

#### Special rendering behavior[](_reference_react-dom_components_title.md#special-rendering-behavior)
...
#### Parameters[](_reference_react-dom_createPortal.md#parameters)

- `children`: Anything that can be rendered with React, such as a piece of JSX (e.g. `<div />` or `<SomeComponent />`), a [Fragment](_reference_react_Fragment.md) (`<>...</>`), a string or a number, or an array of these.
...
#### Returns[](_reference_react-dom_createPortal.md#returns)

`createPortal` returns a React node that can be included into JSX or returned from a React component. If React encounters it in the render output, it will place the provided `children` inside the provided `domNode`.

#### Caveats[](_reference_react-dom_createPortal.md#caveats)
...
#### \_reference_react-dom_findDOMNode.md

> Source: https://react.dev/reference/react-dom/findDOMNode
> Scraped: 4/22/2025, 1:21:17 PM

### Deprecated

`findDOMNode` finds the browser DOM node for a React [class component](_reference_react_Component.md) instance.

```
const domNode = findDOMNode(componentInstance)
```

- [Reference](_reference_react-dom_findDOMNode.md#reference)
  - [`findDOMNode(componentInstance)`](_reference_react-dom_findDOMNode.md#finddomnode)
- [Usage](_reference_react-dom_findDOMNode.md#usage)
  - [Finding the root DOM node of a class component](_reference_react-dom_findDOMNode.md#finding-the-root-dom-node-of-a-class-component)
- [Alternatives](_reference_react-dom_findDOMNode.md#alternatives)
  - [Reading component’s own DOM node from a ref](_reference_react-dom_findDOMNode.md#reading-components-own-dom-node-from-a-ref)
  - [Reading a child component’s DOM node from a forwarded ref](_reference_react-dom_findDOMNode.md#reading-a-child-components-dom-node-from-a-forwarded-ref)
  - [Adding a wrapper `<div>` element](_reference_react-dom_findDOMNode.md#adding-a-wrapper-div-element)
...
Call `findDOMNode` to find the browser DOM node for a given React [class component](_reference_react_Component.md) instance.
...
[See more examples below.](_reference_react-dom_findDOMNode.md#usage)

#### Parameters[](_reference_react-dom_findDOMNode.md#parameters)

- `componentInstance`: An instance of the [`Component`](_reference_react_Component.md) subclass. For example, `this` inside a class component.

#### Returns[](_reference_react-dom_findDOMNode.md#returns)
...
#### Caveats[](_reference_react-dom_findDOMNode.md#caveats)

- A component may return an array or a [Fragment](_reference_react_Fragment.md) with multiple children. In that case `findDOMNode`, will return the DOM node corresponding to the first non-empty child.
...
Call `findDOMNode` with a [class component](_reference_react_Component.md) instance (usually, `this`) to find the DOM node it has rendered.
...
This will break the code because now, `findDOMNode(this)` finds the `<div>` DOM node, but the code expects an `<input>` DOM node. To avoid these kinds of problems, use [`createRef`](_reference_react_createRef.md) to manage a specific DOM node.
...
In modern React without class components, the equivalent code would call [`useRef`](_reference_react_useRef.md) instead:
...
1.  `AutoSelectingInput` should declare a ref, like [in the earlier example](_reference_react-dom_findDOMNode.md#reading-components-own-dom-node-from-a-ref), and pass it to `<MyInput>`.
2.  `MyInput` should be declared with [`forwardRef`](_reference_react_forwardRef.md) to take that ref and forward it down to the `<input>` node.
...
#### Parameters[](_reference_react-dom_flushSync.md#parameters)

- `callback`: A function. React will immediately call this callback and flush any updates it contains synchronously. It may also flush any pending updates, or Effects, or updates inside of Effects. If an update suspends as a result of this `flushSync` call, the fallbacks may be re-shown.

#### Returns[](_reference_react-dom_flushSync.md#returns)

`flushSync` returns `undefined`.

#### Caveats[](_reference_react-dom_flushSync.md#caveats)
...
The `react-dom` package contains Hooks that are only supported for web applications (which run in the browser DOM environment). These Hooks are not supported in non-browser environments like iOS, Android, or Windows applications. If you are looking for Hooks that are supported in web browsers _and other environments_ see [the React Hooks page](_reference_react.md). This page lists all the Hooks in the `react-dom` package.

---

## Form Hooks[](_reference_react-dom_hooks.md#form-hooks)
...
#### Parameters[](_reference_react-dom_hooks_useFormStatus.md#parameters)

`useFormStatus` does not take any parameters.

#### Returns[](_reference_react-dom_hooks_useFormStatus.md#returns)
...
#### Caveats[](_reference_react-dom_hooks_useFormStatus.md#caveats)
...
##### `useFormStatus` will not return status information for a `<form>` rendered in the same component.[](_reference_react-dom_hooks_useFormStatus.md#useformstatus-will-not-return-status-information-for-a-form-rendered-in-the-same-component)
...
#### \_reference_react-dom_hydrate.md
...
In React 18, `hydrate` was replaced by [`hydrateRoot`.](_reference_react-dom_client_hydrateRoot.md) Using `hydrate` in React 18 will warn that your app will behave as if it’s running React 17. Learn more [here.](_blog_2022_03_08_react-18-upgrade-guide.md#updates-to-client-rendering-apis)

`hydrate` lets you display React components inside a browser DOM node whose HTML content was previously generated by [`react-dom/server`](_reference_react-dom_server.md) in React 17 and below.

```
hydrate(reactNode, domNode, callback?)
```

- [Reference](_reference_react-dom_hydrate.md#reference)
  - [`hydrate(reactNode, domNode, callback?)`](_reference_react-dom_hydrate.md#hydrate)
- [Usage](_reference_react-dom_hydrate.md#usage)
  - [Hydrating server-rendered HTML](_reference_react-dom_hydrate.md#hydrating-server-rendered-html)
  - [Suppressing unavoidable hydration mismatch errors](_reference_react-dom_hydrate.md#suppressing-unavoidable-hydration-mismatch-errors)
  - [Handling different client and server content](_reference_react-dom_hydrate.md#handling-different-client-and-server-content)
...
[See more examples below.](_reference_react-dom_hydrate.md#usage)

#### Parameters[](_reference_react-dom_hydrate.md#parameters)
...
#### Returns[](_reference_react-dom_hydrate.md#returns)

`hydrate` returns null.

#### Caveats[](_reference_react-dom_hydrate.md#caveats)
...
- If your app is client-rendered with no HTML rendered already, using `hydrate()` is not supported. Use [render()](_reference_react-dom_render.md) (for React 17 and below) or [createRoot()](_reference_react-dom_client_createRoot.md) (for React 18+) instead.
...
Using `hydrate()` to render a client-only app (an app without server-rendered HTML) is not supported. Use [`render()`](_reference_react-dom_render.md) (in React 17 and below) or [`createRoot()`](_reference_react-dom_client_createRoot.md) (in React 18+) instead.
...
Usually you shouldn’t need to call `hydrate` again or to call it in more places. From this point on, React will be managing the DOM of your application. To update the UI, your components will [use state.](_reference_react_useState.md)

For more information on hydration, see the docs for [`hydrateRoot`.](_reference_react-dom_client_hydrateRoot.md)
...
[React-based frameworks](_learn_start-a-new-react-project.md) frequently handle resource loading for you, so you might not have to call this API yourself. Consult your framework’s documentation for details.
...
#### Parameters[](_reference_react-dom_preinitModule.md#parameters)
...
#### Returns[](_reference_react-dom_preinitModule.md#returns)

`preinitModule` returns nothing.

#### Caveats[](_reference_react-dom_preinitModule.md#caveats)
...
#### Parameters[](_reference_react-dom_preloadModule.md#parameters)
...
#### Returns[](_reference_react-dom_preloadModule.md#returns)

`preloadModule` returns nothing.

#### Caveats[](_reference_react-dom_preloadModule.md#caveats)
...
#### \_reference_react-dom_render.md
...
In React 18, `render` was replaced by [`createRoot`.](_reference_react-dom_client_createRoot.md) Using `render` in React 18 will warn that your app will behave as if it’s running React 17. Learn more [here.](_blog_2022_03_08_react-18-upgrade-guide.md#updates-to-client-rendering-apis)

`render` renders a piece of [JSX](_learn_writing-markup-with-jsx.md) (“React node”) into a browser DOM node.

```
render(reactNode, domNode, callback?)
```

- [Reference](_reference_react-dom_render.md#reference)
  - [`render(reactNode, domNode, callback?)`](_reference_react-dom_render.md#render)
- [Usage](_reference_react-dom_render.md#usage)
  - [Rendering the root component](_reference_react-dom_render.md#rendering-the-root-component)
  - [Rendering multiple roots](_reference_react-dom_render.md#rendering-multiple-roots)
  - [Updating the rendered tree](_reference_react-dom_render.md#updating-the-rendered-tree)
...
[See more examples below.](_reference_react-dom_render.md#usage)

#### Parameters[](_reference_react-dom_render.md#parameters)

- `reactNode`: A _React node_ that you want to display. This will usually be a piece of JSX like `<App />`, but you can also pass a React element constructed with [`createElement()`](_reference_react_createElement.md), a string, a number, `null`, or `undefined`.
- `domNode`: A [DOM element.](https://developer.mozilla.org/en-US/docs/Web/API/Element) React will display the `reactNode` you pass inside this DOM element. From this moment, React will manage the DOM inside the `domNode` and update it when your React tree changes.
- **optional** `callback`: A function. If passed, React will call it after your component is placed into the DOM.

#### Returns[](_reference_react-dom_render.md#returns)
...
#### Caveats[](_reference_react-dom_render.md#caveats)

- In React 18, `render` was replaced by [`createRoot`.](_reference_react-dom_client_createRoot.md) Please use `createRoot` for React 18 and beyond.
- The first time you call `render`, React will clear all the existing HTML content inside the `domNode` before rendering the React component into it. If your `domNode` contains HTML generated by React on the server or during the build, use [`hydrate()`](_reference_react-dom_hydrate.md) instead, which attaches the event handlers to the existing HTML.
- If you call `render` on the same `domNode` more than once, React will update the DOM as necessary to reflect the latest JSX you passed. React will decide which parts of the DOM can be reused and which need to be recreated by [“matching it up”](_learn_preserving-and-resetting-state.md) with the previously rendered tree. Calling `render` on the same `domNode` again is similar to calling the [`set` function](_reference_react_useState.md#setstate) on the root component: React avoids unnecessary DOM updates.
- If your app is fully built with React, you’ll likely have only one `render` call in your app. (If you use a framework, it might do this call for you.) When you want to render a piece of JSX in a different part of the DOM tree that isn’t a child of your component (for example, a modal or a tooltip), use [`createPortal`](_reference_react-dom_createPortal.md) instead of `render`.
...
Usually you shouldn’t need to call `render` again or to call it in more places. From this point on, React will be managing the DOM of your application. To update the UI, your components will [use state.](_reference_react_useState.md)

---

### Rendering multiple roots[](_reference_react-dom_render.md#rendering-multiple-roots)

If your page [isn’t fully built with React](_learn_add-react-to-an-existing-project.md#using-react-for-a-part-of-your-existing-page), call `render` for each top-level piece of UI managed by React.

You can destroy the rendered trees with [`unmountComponentAtNode()`.](_reference_react-dom_unmountComponentAtNode.md)

---

### Updating the rendered tree[](_reference_react-dom_render.md#updating-the-rendered-tree)

You can call `render` more than once on the same DOM node. As long as the component tree structure matches up with what was previously rendered, React will [preserve the state.](_learn_preserving-and-resetting-state.md) Notice how you can type in the input, which means that the updates from repeated `render` calls every second are not destructive:

It is uncommon to call `render` multiple times. Usually, you’ll [update state](_reference_react_useState.md) inside your components instead.
...
The `react-dom/server` APIs let you server-side render React components to HTML. These APIs are only used on the server at the top level of your app to generate the initial HTML. A [framework](_learn_start-a-new-react-project.md#production-grade-react-frameworks) may call them for you. Most of your components don’t need to import or use them.

---

## Server APIs for Node.js Streams[](_reference_react-dom_server.md#server-apis-for-nodejs-streams)

These methods are only available in the environments with [Node.js Streams:](https://nodejs.org/api/stream.html)

- [`renderToPipeableStream`](_reference_react-dom_server_renderToPipeableStream.md) renders a React tree to a pipeable [Node.js Stream.](https://nodejs.org/api/stream.html)

---

## Server APIs for Web Streams[](_reference_react-dom_server.md#server-apis-for-web-streams)

These methods are only available in the environments with [Web Streams](https://developer.mozilla.org/en-US/docs/Web/API/Streams_API), which includes browsers, Deno, and some modern edge runtimes:

- [`renderToReadableStream`](_reference_react-dom_server_renderToReadableStream.md) renders a React tree to a [Readable Web Stream.](https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream)

---

## Legacy Server APIs for non-streaming environments[](_reference_react-dom_server.md#legacy-server-apis-for-non-streaming-environments)

These methods can be used in the environments that don’t support streams:

- [`renderToString`](_reference_react-dom_server_renderToString.md) renders a React tree to a string.
- [`renderToStaticMarkup`](_reference_react-dom_server_renderToStaticMarkup.md) renders a non-interactive React tree to a string.

They have limited functionality compared to the streaming APIs.

#### \_reference_react-dom_server_renderToNodeStream.md
...
- [Reference](_reference_react-dom_server_renderToNodeStream.md#reference)
  - [`renderToNodeStream(reactNode, options?)`](_reference_react-dom_server_renderToNodeStream.md#rendertonodestream)
- [Usage](_reference_react-dom_server_renderToNodeStream.md#usage)
  - [Rendering a React tree as HTML to a Node.js Readable Stream](_reference_react-dom_server_renderToNodeStream.md#rendering-a-react-tree-as-html-to-a-nodejs-readable-stream)
...
[See more examples below.](_reference_react-dom_server_renderToNodeStream.md#usage)

#### Parameters[](_reference_react-dom_server_renderToNodeStream.md#parameters)
...
#### Returns[](_reference_react-dom_server_renderToNodeStream.md#returns)

A [Node.js Readable Stream](https://nodejs.org/api/stream.html#readable-streams) that outputs an HTML string.

#### Caveats[](_reference_react-dom_server_renderToNodeStream.md#caveats)

- This method will wait for all [Suspense boundaries](_reference_react_Suspense.md) to complete before returning any output.
- As of React 18, this method buffers all of its output, so it doesn’t actually provide any streaming benefits. This is why it’s recommended that you migrate to [`renderToPipeableStream`](_reference_react-dom_server_renderToPipeableStream.md) instead.
...
The stream will produce the initial non-interactive HTML output of your React components. On the client, you will need to call [`hydrateRoot`](_reference_react-dom_client_hydrateRoot.md) to _hydrate_ that server-generated HTML and make it interactive.
...
#### Parameters[](_reference_react-dom_server_renderToPipeableStream.md#parameters)
...
#### Returns[](_reference_react-dom_server_renderToPipeableStream.md#returns)
...
#### Reading CSS and JS asset paths from the build output[](_reference_react-dom_server_renderToPipeableStream.md#reading-css-and-js-asset-paths-from-the-build-output)
...
#### Parameters[](_reference_react-dom_server_renderToReadableStream.md#parameters)
...
#### Returns[](_reference_react-dom_server_renderToReadableStream.md#returns)
...
#### Reading CSS and JS asset paths from the build output[](_reference_react-dom_server_renderToReadableStream.md#reading-css-and-js-asset-paths-from-the-build-output)
...
#### Parameters[](_reference_react-dom_server_renderToStaticMarkup.md#parameters)

- `reactNode`: A React node you want to render to HTML. For example, a JSX node like `<Page />`.
- **optional** `options`: An object for server render.
  - **optional** `identifierPrefix`: A string prefix React uses for IDs generated by [`useId`.](_reference_react_useId.md) Useful to avoid conflicts when using multiple roots on the same page.

#### Returns[](_reference_react-dom_server_renderToStaticMarkup.md#returns)

An HTML string.

#### Caveats[](_reference_react-dom_server_renderToStaticMarkup.md#caveats)
...
#### \_reference_react-dom_server_renderToStaticNodeStream.md
...
- [Reference](_reference_react-dom_server_renderToStaticNodeStream.md#reference)
  - [`renderToStaticNodeStream(reactNode, options?)`](_reference_react-dom_server_renderToStaticNodeStream.md#rendertostaticnodestream)
- [Usage](_reference_react-dom_server_renderToStaticNodeStream.md#usage)
  - [Rendering a React tree as static HTML to a Node.js Readable Stream](_reference_react-dom_server_renderToStaticNodeStream.md#rendering-a-react-tree-as-static-html-to-a-nodejs-readable-stream)
...
[See more examples below.](_reference_react-dom_server_renderToStaticNodeStream.md#usage)

The stream will produce non-interactive HTML output of your React components.

#### Parameters[](_reference_react-dom_server_renderToStaticNodeStream.md#parameters)
...
#### Returns[](_reference_react-dom_server_renderToStaticNodeStream.md#returns)
...
#### Caveats[](_reference_react-dom_server_renderToStaticNodeStream.md#caveats)
...
Interactive apps should use [`renderToPipeableStream`](_reference_react-dom_server_renderToPipeableStream.md) on the server and [`hydrateRoot`](_reference_react-dom_client_hydrateRoot.md) on the client.
...
#### Parameters[](_reference_react-dom_server_renderToString.md#parameters)
...
#### Returns[](_reference_react-dom_server_renderToString.md#returns)

An HTML string.

#### Caveats[](_reference_react-dom_server_renderToString.md#caveats)
...
The `react-dom/static` APIs let you generate static HTML for React components. They have limited functionality compared to the streaming APIs. A [framework](_learn_start-a-new-react-project.md#production-grade-react-frameworks) may call them for you. Most of your components don’t need to import or use them.

---

## Static APIs for Web Streams[](_reference_react-dom_static.md#static-apis-for-web-streams)
...
## Static APIs for Node.js Streams[](_reference_react-dom_static.md#static-apis-for-nodejs-streams)
...
#### Parameters[](_reference_react-dom_static_prerender.md#parameters)
...
#### Returns[](_reference_react-dom_static_prerender.md#returns)
...
### When should I use `prerender`?[](_reference_react-dom_static_prerender.md#when-to-use-prerender)
...
#### Reading CSS and JS asset paths from the build output[](_reference_react-dom_static_prerender.md#reading-css-and-js-asset-paths-from-the-build-output)
...
#### Parameters[](_reference_react-dom_static_prerenderToNodeStream.md#parameters)
...
- **optional** `options`: An object with static generation options.
  ...
  - **optional** `onError`: A callback that fires whenever there is a server error, whether [recoverable](_reference_react-dom_server_renderToPipeableStream.md#recovering-from-errors-outside-the-shell) or [not.](_reference_react-dom_server_renderToPipeableStream.md#recovering-from-errors-inside-the-shell) By default, this only calls `console.error`. If you override it to [log crash reports,](_reference_react-dom_server_renderToPipeableStream.md#logging-crashes-on-the-server) make sure that you still call `console.error`. You can also use it to [adjust the status code](_reference_react-dom_server_renderToPipeableStream.md#setting-the-status-code) before the shell is emitted.
  - **optional** `progressiveChunkSize`: The number of bytes in a chunk. [Read more about the default heuristic.](https://github.com/facebook/react/blob/14c2be8dac2d5482fda8a0906a31d239df8551fc/packages/react-server/src/ReactFizzServer.js#L210-L225)
  - **optional** `signal`: An [abort signal](https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal) that lets you [abort server rendering](_reference_react-dom_server_renderToPipeableStream.md#aborting-server-rendering) and render the rest on the client.

#### Returns[](_reference_react-dom_static_prerenderToNodeStream.md#returns)
...
### When should I use `prerenderToNodeStream`?[](_reference_react-dom_static_prerenderToNodeStream.md#when-to-use-prerender)
...
#### Reading CSS and JS asset paths from the build output[](_reference_react-dom_static_prerenderToNodeStream.md#reading-css-and-js-asset-paths-from-the-build-output)
...
#### \_reference_react-dom_unmountComponentAtNode.md

> Source: https://react.dev/reference/react-dom/unmountComponentAtNode
> Scraped: 4/22/2025, 1:21:15 PM
...
## React[](_reference_react.md#react)
...
## React DOM[](_reference_react.md#react-dom)
...
## Rules of React[](_reference_react.md#rules-of-react)
...
`Children` lets you manipulate and transform the JSX you received as the [`children` prop.](_learn_passing-props-to-a-component.md#passing-jsx-as-children)
...
- [Reference](_reference_react_Children.md#reference)
  - [`Children.count(children)`](_reference_react_Children.md#children-count)
  - [`Children.forEach(children, fn, thisArg?)`](_reference_react_Children.md#children-foreach)
  - [`Children.map(children, fn, thisArg?)`](_reference_react_Children.md#children-map)
  - [`Children.only(children)`](_reference_react_Children.md#children-only)
  - [`Children.toArray(children)`](_reference_react_Children.md#children-toarray)
- [Usage](_reference_react_Children.md#usage)
  - [Transforming children](_reference_react_Children.md#transforming-children)
  - [Running some code for each child](_reference_react_Children.md#running-some-code-for-each-child)
  - [Counting children](_reference_react_Children.md#counting-children)
  - [Converting children to an array](_reference_react_Children.md#converting-children-to-an-array)
- [Alternatives](_reference_react_Children.md#alternatives)
  - [Exposing multiple components](_reference_react_Children.md#exposing-multiple-components)
  - [Accepting an array of objects as a prop](_reference_react_Children.md#accepting-an-array-of-objects-as-a-prop)
  - [Calling a render prop to customize rendering](_reference_react_Children.md#calling-a-render-prop-to-customize-rendering)
- [Troubleshooting](_reference_react_Children.md#troubleshooting)
  - [I pass a custom component, but the `Children` methods don’t show its render result](_reference_react_Children.md#i-pass-a-custom-component-but-the-children-methods-dont-show-its-render-result)
...
[See more examples below.](_reference_react_Children.md#counting-children)

#### Parameters[](_reference_react_Children.md#children-count-parameters)

- `children`: The value of the [`children` prop](_learn_passing-props-to-a-component.md#passing-jsx-as-children) received by your component.

#### Returns[](_reference_react_Children.md#children-count-returns)

The number of nodes inside these `children`.

#### Caveats[](_reference_react_Children.md#children-count-caveats)

- Empty nodes (`null`, `undefined`, and Booleans), strings, numbers, and [React elements](_reference_react_createElement.md) count as individual nodes. Arrays don’t count as individual nodes, but their children do. **The traversal does not go deeper than React elements:** they don’t get rendered, and their children aren’t traversed. [Fragments](_reference_react_Fragment.md) don’t get traversed.
...
[See more examples below.](_reference_react_Children.md#running-some-code-for-each-child)

#### Parameters[](_reference_react_Children.md#children-foreach-parameters)
...
#### Returns[](_reference_react_Children.md#children-foreach-returns)

`Children.forEach` returns `undefined`.

#### Caveats[](_reference_react_Children.md#children-foreach-caveats)
...
[See more examples below.](_reference_react_Children.md#transforming-children)

#### Parameters[](_reference_react_Children.md#children-map-parameters)
...
#### Returns[](_reference_react_Children.md#children-map-returns)

If `children` is `null` or `undefined`, returns the same value.

Otherwise, returns a flat array consisting of the nodes you’ve returned from the `fn` function. The returned array will contain all nodes you returned except for `null` and `undefined`.

#### Caveats[](_reference_react_Children.md#children-map-caveats)
...
#### Parameters[](_reference_react_Children.md#children-only-parameters)

- `children`: The value of the [`children` prop](_learn_passing-props-to-a-component.md#passing-jsx-as-children) received by your component.

#### Returns[](_reference_react_Children.md#children-only-returns)

If `children` [is a valid element,](_reference_react_isValidElement.md) returns that element.

Otherwise, throws an error.

#### Caveats[](_reference_react_Children.md#children-only-caveats)
...
#### Parameters[](_reference_react_Children.md#children-toarray-parameters)

- `children`: The value of the [`children` prop](_learn_passing-props-to-a-component.md#passing-jsx-as-children) received by your component.

#### Returns[](_reference_react_Children.md#children-toarray-returns)

Returns a flat array of elements in `children`.

#### Caveats[](_reference_react_Children.md#children-toarray-caveats)
...
To transform the children JSX that your component [receives as the `children` prop,](_learn_passing-props-to-a-component.md#passing-jsx-as-children) call `Children.map`:
...
`Children.map` is similar to [to transforming arrays with `map()`.](_learn_rendering-lists.md) The difference is that the `children` data structure is considered _opaque._ This means that even if it’s sometimes an array, you should not assume it’s an array or any other particular data type. This is why you should use `Children.map` if you need to transform it.

##### Deep Dive

#### Why is the children prop not always an array?[](_reference_react_Children.md#why-is-the-children-prop-not-always-an-array)
...
Even when `children` is an array, `Children.map` has useful special behavior. For example, `Children.map` combines the [keys](_learn_rendering-lists.md#keeping-list-items-in-order-with-key) on the returned elements with the keys on the `children` you’ve passed to it. This ensures the original JSX children don’t “lose” keys even if they get wrapped like in the example above.
...
**There is no way to get the rendered output of an inner component** like `<MoreRows />` when manipulating `children`. This is why [it’s usually better to use one of the alternative solutions.](_reference_react_Children.md#alternatives)
...
Don’t confuse it with [using the `children` prop](_learn_passing-props-to-a-component.md#passing-jsx-as-children) (lowercase `c`), which is good and encouraged.
...
Unlike using `Children.map`, this approach does not wrap every child automatically. **However, this approach has a significant benefit compared to the [earlier example with `Children.map`](_reference_react_Children.md#transforming-children) because it works even if you keep extracting more components.** For example, it still works if you extract your own `MoreRows` component:
...
The limitation makes it hard to extract a component. This is why [alternatives](_reference_react_Children.md#alternatives) are preferred to using `Children`.

#### \_reference_react_Component.md

> Source: https://react.dev/reference/react/Component
> Scraped: 4/22/2025, 1:21:13 PM
...
- [Reference](_reference_react_Component.md#reference)
  - [`Component`](_reference_react_Component.md#component)
  - [`context`](_reference_react_Component.md#context)
  - [`props`](_reference_react_Component.md#props)
  - [`state`](_reference_react_Component.md#state)
  - [`constructor(props)`](_reference_react_Component.md#constructor)
  - [`componentDidCatch(error, info)`](_reference_react_Component.md#componentdidcatch)
  - [`componentDidMount()`](_reference_react_Component.md#componentdidmount)
  - [`componentDidUpdate(prevProps, prevState, snapshot?)`](_reference_react_Component.md#componentdidupdate)
  - [`componentWillMount()`](_reference_react_Component.md#componentwillmount)
  - [`componentWillReceiveProps(nextProps)`](_reference_react_Component.md#componentwillreceiveprops)
  - [`componentWillUpdate(nextProps, nextState)`](_reference_react_Component.md#componentwillupdate)
  - [`componentWillUnmount()`](_reference_react_Component.md#componentwillunmount)
  - [`forceUpdate(callback?)`](_reference_react_Component.md#forceupdate)
  - [`getSnapshotBeforeUpdate(prevProps, prevState)`](_reference_react_Component.md#getsnapshotbeforeupdate)
  - [`render()`](_reference_react_Component.md#render)
  - [`setState(nextState, callback?)`](_reference_react_Component.md#setstate)
  - [`shouldComponentUpdate(nextProps, nextState, nextContext)`](_reference_react_Component.md#shouldcomponentupdate)
  - [`UNSAFE_componentWillMount()`](_reference_react_Component.md#unsafe_componentwillmount)
  - [`UNSAFE_componentWillReceiveProps(nextProps, nextContext)`](_reference_react_Component.md#unsafe_componentwillreceiveprops)
  - [`UNSAFE_componentWillUpdate(nextProps, nextState)`](_reference_react_Component.md#unsafe_componentwillupdate)
  - [`static contextType`](_reference_react_Component.md#static-contexttype)
  - [`static defaultProps`](_reference_react_Component.md#static-defaultprops)
  - [`static getDerivedStateFromError(error)`](_reference_react_Component.md#static-getderivedstatefromerror)
  - [`static getDerivedStateFromProps(props, state)`](_reference_react_Component.md#static-getderivedstatefromprops)
- [Usage](_reference_react_Component.md#usage)
  - [Defining a class component](_reference_react_Component.md#defining-a-class-component)
  - [Adding state to a class component](_reference_react_Component.md#adding-state-to-a-class-component)
  - [Adding lifecycle methods to a class component](_reference_react_Component.md#adding-lifecycle-methods-to-a-class-component)
  - [Catching rendering errors with an error boundary](_reference_react_Component.md#catching-rendering-errors-with-an-error-boundary)
- [Alternatives](_reference_react_Component.md#alternatives)
  - [Migrating a simple component from a class to a function](_reference_react_Component.md#migrating-a-simple-component-from-a-class-to-a-function)
  - [Migrating a component with state from a class to a function](_reference_react_Component.md#migrating-a-component-with-state-from-a-class-to-a-function)
  - [Migrating a component with lifecycle methods from a class to a function](_reference_react_Component.md#migrating-a-component-with-lifecycle-methods-from-a-class-to-a-function)
  - [Migrating a component with context from a class to a function](_reference_react_Component.md#migrating-a-component-with-context-from-a-class-to-a-function)
...
To define a React component as a class, extend the built-in `Component` class and define a [`render` method:](_reference_react_Component.md#render)
...
[See more examples below.](_reference_react_Component.md#usage)

---

### `context`[](_reference_react_Component.md#context)

The [context](_learn_passing-data-deeply-with-context.md) of a class component is available as `this.context`. It is only available if you specify _which_ context you want to receive using [`static contextType`](_reference_react_Component.md#static-contexttype).
...
#### Parameters[](_reference_react_Component.md#constructor-parameters)

- `props`: The component’s initial props.

#### Returns[](_reference_react_Component.md#constructor-returns)

`constructor` should not return anything.

#### Caveats[](_reference_react_Component.md#constructor-caveats)

- Do not run any side effects or subscriptions in the constructor. Instead, use [`componentDidMount`](_reference_react_Component.md#componentdidmount) for that.
...
- Constructor is the only place where you can assign [`this.state`](_reference_react_Component.md#state) directly. In all other methods, you need to use [`this.setState()`](_reference_react_Component.md#setstate) instead. Do not call `setState` in the constructor.
- When you use [server rendering,](_reference_react-dom_server.md) the constructor will run on the server too, followed by the [`render`](_reference_react_Component.md#render) method. However, lifecycle methods like `componentDidMount` or `componentWillUnmount` will not run on the server.
- When [Strict Mode](_reference_react_StrictMode.md) is on, React will call `constructor` twice in development and then throw away one of the instances. This helps you notice the accidental side effects that need to be moved out of the `constructor`.

### Note

There is no exact equivalent for `constructor` in function components. To declare state in a function component, call [`useState`.](_reference_react_useState.md) To avoid recalculating the initial state, [pass a function to `useState`.](_reference_react_useState.md#avoiding-recreating-the-initial-state)
...
Typically, it is used together with [`static getDerivedStateFromError`](_reference_react_Component.md#static-getderivedstatefromerror) which lets you update state in response to an error and display an error message to the user. A component with these methods is called an _error boundary._

[See an example.](_reference_react_Component.md#catching-rendering-errors-with-an-error-boundary)

#### Parameters[](_reference_react_Component.md#componentdidcatch-parameters)
...
#### Returns[](_reference_react_Component.md#componentdidcatch-returns)

`componentDidCatch` should not return anything.

#### Caveats[](_reference_react_Component.md#componentdidcatch-caveats)

- In the past, it was common to call `setState` inside `componentDidCatch` in order to update the UI and display the fallback error message. This is deprecated in favor of defining [`static getDerivedStateFromError`.](_reference_react_Component.md#static-getderivedstatefromerror)
...
If you implement `componentDidMount`, you usually need to implement other lifecycle methods to avoid bugs. For example, if `componentDidMount` reads some state or props, you also have to implement [`componentDidUpdate`](_reference_react_Component.md#componentdidupdate) to handle their changes, and [`componentWillUnmount`](_reference_react_Component.md#componentwillunmount) to clean up whatever `componentDidMount` was doing.
...
[See more examples.](_reference_react_Component.md#adding-lifecycle-methods-to-a-class-component)

#### Parameters[](_reference_react_Component.md#componentdidmount-parameters)

`componentDidMount` does not take any parameters.

#### Returns[](_reference_react_Component.md#componentdidmount-returns)

`componentDidMount` should not return anything.

#### Caveats[](_reference_react_Component.md#componentdidmount-caveats)

- When [Strict Mode](_reference_react_StrictMode.md) is on, in development React will call `componentDidMount`, then immediately call [`componentWillUnmount`,](_reference_react_Component.md#componentwillunmount) and then call `componentDidMount` again. This helps you notice if you forgot to implement `componentWillUnmount` or if its logic doesn’t fully “mirror” what `componentDidMount` does.
- Although you may call [`setState`](_reference_react_Component.md#setstate) immediately in `componentDidMount`, it’s best to avoid that when you can. It will trigger an extra rendering, but it will happen before the browser updates the screen. This guarantees that even though the [`render`](_reference_react_Component.md#render) will be called twice in this case, the user won’t see the intermediate state. Use this pattern with caution because it often causes performance issues. In most cases, you should be able to assign the initial state in the [`constructor`](_reference_react_Component.md#constructor) instead. It can, however, be necessary for cases like modals and tooltips when you need to measure a DOM node before rendering something that depends on its size or position.

### Note

For many use cases, defining `componentDidMount`, `componentDidUpdate`, and `componentWillUnmount` together in class components is equivalent to calling [`useEffect`](_reference_react_useEffect.md) in function components. In the rare cases where it’s important for the code to run before browser paint, [`useLayoutEffect`](_reference_react_useLayoutEffect.md) is a closer match.

[See how to migrate.](_reference_react_Component.md#migrating-a-component-with-lifecycle-methods-from-a-class-to-a-function)
...
You can use it to manipulate the DOM after an update. This is also a common place to do network requests as long as you compare the current props to previous props (e.g. a network request may not be necessary if the props have not changed). Typically, you’d use it together with [`componentDidMount`](_reference_react_Component.md#componentdidmount) and [`componentWillUnmount`:](_reference_react_Component.md#componentwillunmount)
...
#### Parameters[](_reference_react_Component.md#componentdidupdate-parameters)

- `prevProps`: Props before the update. Compare `prevProps` to [`this.props`](_reference_react_Component.md#props) to determine what changed.
- `prevState`: State before the update. Compare `prevState` to [`this.state`](_reference_react_Component.md#state) to determine what changed.
- `snapshot`: If you implemented [`getSnapshotBeforeUpdate`](_reference_react_Component.md#getsnapshotbeforeupdate), `snapshot` will contain the value you returned from that method. Otherwise, it will be `undefined`.

#### Returns[](_reference_react_Component.md#componentdidupdate-returns)

`componentDidUpdate` should not return anything.

#### Caveats[](_reference_react_Component.md#componentdidupdate-caveats)

- `componentDidUpdate` will not get called if [`shouldComponentUpdate`](_reference_react_Component.md#shouldcomponentupdate) is defined and returns `false`.
...
- Although you may call [`setState`](_reference_react_Component.md#setstate) immediately in `componentDidUpdate`, it’s best to avoid that when you can. It will trigger an extra rendering, but it will happen before the browser updates the screen. This guarantees that even though the [`render`](_reference_react_Component.md#render) will be called twice in this case, the user won’t see the intermediate state. This pattern often causes performance issues, but it may be necessary for rare cases like modals and tooltips when you need to measure a DOM node before rendering something that depends on its size or position.
...
The logic inside `componentWillUnmount` should “mirror” the logic inside [`componentDidMount`.](_reference_react_Component.md#componentdidmount) For example, if `componentDidMount` sets up a subscription, `componentWillUnmount` should clean up that subscription. If the cleanup logic in your `componentWillUnmount` reads some props or state, you will usually also need to implement [`componentDidUpdate`](_reference_react_Component.md#componentdidupdate) to clean up resources (such as subscriptions) corresponding to the old props and state.
...
#### Parameters[](_reference_react_Component.md#componentwillunmount-parameters)

`componentWillUnmount` does not take any parameters.

#### Returns[](_reference_react_Component.md#componentwillunmount-returns)

`componentWillUnmount` should not return anything.

#### Caveats[](_reference_react_Component.md#componentwillunmount-caveats)

- When [Strict Mode](_reference_react_StrictMode.md) is on, in development React will call [`componentDidMount`,](_reference_react_Component.md#componentdidmount) then immediately call `componentWillUnmount`, and then call `componentDidMount` again. This helps you notice if you forgot to implement `componentWillUnmount` or if its logic doesn’t fully “mirror” what `componentDidMount` does.
...
Usually, this is not necessary. If your component’s [`render`](_reference_react_Component.md#render) method only reads from [`this.props`](_reference_react_Component.md#props), [`this.state`](_reference_react_Component.md#state), or [`this.context`,](_reference_react_Component.md#context) it will re-render automatically when you call [`setState`](_reference_react_Component.md#setstate) inside your component or one of its parents. However, if your component’s `render` method reads directly from an external data source, you have to tell React to update the user interface when that data source changes. That’s what `forceUpdate` lets you do.

Try to avoid all uses of `forceUpdate` and only read from `this.props` and `this.state` in `render`.

#### Parameters[](_reference_react_Component.md#forceupdate-parameters)

- **optional** `callback` If specified, React will call the `callback` you’ve provided after the update is committed.

#### Returns[](_reference_react_Component.md#forceupdate-returns)

`forceUpdate` does not return anything.

#### Caveats[](_reference_react_Component.md#forceupdate-caveats)

- If you call `forceUpdate`, React will re-render without calling [`shouldComponentUpdate`.](_reference_react_Component.md#shouldcomponentupdate)

### Note

Reading an external data source and forcing class components to re-render in response to its changes with `forceUpdate` has been superseded by [`useSyncExternalStore`](_reference_react_useSyncExternalStore.md) in function components.

---

### `getSnapshotBeforeUpdate(prevProps, prevState)`[](_reference_react_Component.md#getsnapshotbeforeupdate)

If you implement `getSnapshotBeforeUpdate`, React will call it immediately before React updates the DOM. It enables your component to capture some information from the DOM (e.g. scroll position) before it is potentially changed. Any value returned by this lifecycle method will be passed as a parameter to [`componentDidUpdate`.](_reference_react_Component.md#componentdidupdate)
...
In the above example, it is important to read the `scrollHeight` property directly in `getSnapshotBeforeUpdate`. It is not safe to read it in [`render`](_reference_react_Component.md#render), [`UNSAFE_componentWillReceiveProps`](_reference_react_Component.md#unsafe_componentwillreceiveprops), or [`UNSAFE_componentWillUpdate`](_reference_react_Component.md#unsafe_componentwillupdate) because there is a potential time gap between these methods getting called and React updating the DOM.

#### Parameters[](_reference_react_Component.md#getsnapshotbeforeupdate-parameters)

- `prevProps`: Props before the update. Compare `prevProps` to [`this.props`](_reference_react_Component.md#props) to determine what changed.
- `prevState`: State before the update. Compare `prevState` to [`this.state`](_reference_react_Component.md#state) to determine what changed.

#### Returns[](_reference_react_Component.md#getsnapshotbeforeupdate-returns)

You should return a snapshot value of any type that you’d like, or `null`. The value you returned will be passed as the third argument to [`componentDidUpdate`.](_reference_react_Component.md#componentdidupdate)

#### Caveats[](_reference_react_Component.md#getsnapshotbeforeupdate-caveats)

- `getSnapshotBeforeUpdate` will not get called if [`shouldComponentUpdate`](_reference_react_Component.md#shouldcomponentupdate) is defined and returns `false`.
...
React may call `render` at any moment, so you shouldn’t assume that it runs at a particular time. Usually, the `render` method should return a piece of [JSX](_learn_writing-markup-with-jsx.md), but a few [other return types](_reference_react_Component.md#render-returns) (like strings) are supported. To calculate the returned JSX, the `render` method can read [`this.props`](_reference_react_Component.md#props), [`this.state`](_reference_react_Component.md#state), and [`this.context`](_reference_react_Component.md#context).

You should write the `render` method as a pure function, meaning that it should return the same result if props, state, and context are the same. It also shouldn’t contain side effects (like setting up subscriptions) or interact with the browser APIs. Side effects should happen either in event handlers or methods like [`componentDidMount`.](_reference_react_Component.md#componentdidmount)

#### Parameters[](_reference_react_Component.md#render-parameters)

`render` does not take any parameters.

#### Returns[](_reference_react_Component.md#render-returns)

`render` can return any valid React node. This includes React elements such as `<div />`, strings, numbers, [portals](_reference_react-dom_createPortal.md), empty nodes (`null`, `undefined`, `true`, and `false`), and arrays of React nodes.

#### Caveats[](_reference_react_Component.md#render-caveats)

- `render` should be written as a pure function of props, state, and context. It should not have side effects.
- `render` will not get called if [`shouldComponentUpdate`](_reference_react_Component.md#shouldcomponentupdate) is defined and returns `false`.
- When [Strict Mode](_reference_react_StrictMode.md) is on, React will call `render` twice in development and then throw away one of the results. This helps you notice the accidental side effects that need to be moved out of the `render` method.
...
#### Parameters[](_reference_react_Component.md#setstate-parameters)
...
#### Returns[](_reference_react_Component.md#setstate-returns)

`setState` does not return anything.

#### Caveats[](_reference_react_Component.md#setstate-caveats)

- Think of `setState` as a _request_ rather than an immediate command to update the component. When multiple components update their state in response to an event, React will batch their updates and re-render them together in a single pass at the end of the event. In the rare case that you need to force a particular state update to be applied synchronously, you may wrap it in [`flushSync`,](_reference_react-dom_flushSync.md) but this may hurt performance.
- `setState` does not update `this.state` immediately. This makes reading `this.state` right after calling `setState` a potential pitfall. Instead, use [`componentDidUpdate`](_reference_react_Component.md#componentdidupdate) or the setState `callback` argument, either of which are guaranteed to fire after the update has been applied. If you need to set the state based on the previous state, you can pass a function to `nextState` as described above.
...
React calls `shouldComponentUpdate` before rendering when new props or state are being received. Defaults to `true`. This method is not called for the initial render or when [`forceUpdate`](_reference_react_Component.md#forceupdate) is used.

#### Parameters[](_reference_react_Component.md#shouldcomponentupdate-parameters)

- `nextProps`: The next props that the component is about to render with. Compare `nextProps` to [`this.props`](_reference_react_Component.md#props) to determine what changed.
- `nextState`: The next state that the component is about to render with. Compare `nextState` to [`this.state`](_reference_react_Component.md#props) to determine what changed.
- `nextContext`: The next context that the component is about to render with. Compare `nextContext` to [`this.context`](_reference_react_Component.md#context) to determine what changed. Only available if you specify [`static contextType`](_reference_react_Component.md#static-contexttype).

#### Returns[](_reference_react_Component.md#shouldcomponentupdate-returns)

Return `true` if you want the component to re-render. That’s the default behavior.

Return `false` to tell React that re-rendering can be skipped.

#### Caveats[](_reference_react_Component.md#shouldcomponentupdate-caveats)

- This method _only_ exists as a performance optimization. If your component breaks without it, fix that first.
- Consider using [`PureComponent`](_reference_react_PureComponent.md) instead of writing `shouldComponentUpdate` by hand. `PureComponent` shallowly compares props and state, and reduces the chance that you’ll skip a necessary update.
...
Optimizing class components with `shouldComponentUpdate` is similar to optimizing function components with [`memo`.](_reference_react_memo.md) Function components also offer more granular optimization with [`useMemo`.](_reference_react_useMemo.md)

---

### `UNSAFE_componentWillMount()`[](_reference_react_Component.md#unsafe_componentwillmount)

If you define `UNSAFE_componentWillMount`, React will call it immediately after the [`constructor`.](_reference_react_Component.md#constructor) It only exists for historical reasons and should not be used in any new code. Instead, use one of the alternatives:

- To initialize state, declare [`state`](_reference_react_Component.md#state) as a class field or set `this.state` inside the [`constructor`.](_reference_react_Component.md#constructor)
- If you need to run a side effect or set up a subscription, move that logic to [`componentDidMount`](_reference_react_Component.md#componentdidmount) instead.
...
#### Parameters[](_reference_react_Component.md#unsafe_componentwillmount-parameters)

`UNSAFE_componentWillMount` does not take any parameters.

#### Returns[](_reference_react_Component.md#unsafe_componentwillmount-returns)

`UNSAFE_componentWillMount` should not return anything.

#### Caveats[](_reference_react_Component.md#unsafe_componentwillmount-caveats)

- `UNSAFE_componentWillMount` will not get called if the component implements [`static getDerivedStateFromProps`](_reference_react_Component.md#static-getderivedstatefromprops) or [`getSnapshotBeforeUpdate`.](_reference_react_Component.md#getsnapshotbeforeupdate)
- Despite its naming, `UNSAFE_componentWillMount` does not guarantee that the component _will_ get mounted if your app uses modern React features like [`Suspense`.](_reference_react_Suspense.md) If a render attempt is suspended (for example, because the code for some child component has not loaded yet), React will throw the in-progress tree away and attempt to construct the component from scratch during the next attempt. This is why this method is “unsafe”. Code that relies on mounting (like adding a subscription) should go into [`componentDidMount`.](_reference_react_Component.md#componentdidmount)
- `UNSAFE_componentWillMount` is the only lifecycle method that runs during [server rendering.](_reference_react-dom_server.md) For all practical purposes, it is identical to [`constructor`,](_reference_react_Component.md#constructor) so you should use the `constructor` for this type of logic instead.

### Note

Calling [`setState`](_reference_react_Component.md#setstate) inside `UNSAFE_componentWillMount` in a class component to initialize state is equivalent to passing that state as the initial state to [`useState`](_reference_react_useState.md) in a function component.
...
- If you need to **run a side effect** (for example, fetch data, run an animation, or reinitialize a subscription) in response to prop changes, move that logic to [`componentDidUpdate`](_reference_react_Component.md#componentdidupdate) instead.
...
- If you need to **“adjust” some state when a prop changes,** check whether you can compute all the necessary information from props alone during rendering. If you can’t, use [`static getDerivedStateFromProps`](_reference_react_Component.md#static-getderivedstatefromprops) instead.
...
#### Parameters[](_reference_react_Component.md#unsafe_componentwillreceiveprops-parameters)

- `nextProps`: The next props that the component is about to receive from its parent component. Compare `nextProps` to [`this.props`](_reference_react_Component.md#props) to determine what changed.
- `nextContext`: The next context that the component is about to receive from the closest provider. Compare `nextContext` to [`this.context`](_reference_react_Component.md#context) to determine what changed. Only available if you specify [`static contextType`](_reference_react_Component.md#static-contexttype).

#### Returns[](_reference_react_Component.md#unsafe_componentwillreceiveprops-returns)

`UNSAFE_componentWillReceiveProps` should not return anything.

#### Caveats[](_reference_react_Component.md#unsafe_componentwillreceiveprops-caveats)

- `UNSAFE_componentWillReceiveProps` will not get called if the component implements [`static getDerivedStateFromProps`](_reference_react_Component.md#static-getderivedstatefromprops) or [`getSnapshotBeforeUpdate`.](_reference_react_Component.md#getsnapshotbeforeupdate)
- Despite its naming, `UNSAFE_componentWillReceiveProps` does not guarantee that the component _will_ receive those props if your app uses modern React features like [`Suspense`.](_reference_react_Suspense.md) If a render attempt is suspended (for example, because the code for some child component has not loaded yet), React will throw the in-progress tree away and attempt to construct the component from scratch during the next attempt. By the time of the next render attempt, the props might be different. This is why this method is “unsafe”. Code that should run only for committed updates (like resetting a subscription) should go into [`componentDidUpdate`.](_reference_react_Component.md#componentdidupdate)
...
- React doesn’t call `UNSAFE_componentWillReceiveProps` with initial props during mounting. It only calls this method if some of component’s props are going to be updated. For example, calling [`setState`](_reference_react_Component.md#setstate) doesn’t generally trigger `UNSAFE_componentWillReceiveProps` inside the same component.
...
- If you need to run a side effect (for example, fetch data, run an animation, or reinitialize a subscription) in response to prop or state changes, move that logic to [`componentDidUpdate`](_reference_react_Component.md#componentdidupdate) instead.
- If you need to read some information from the DOM (for example, to save the current scroll position) so that you can use it in [`componentDidUpdate`](_reference_react_Component.md#componentdidupdate) later, read it inside [`getSnapshotBeforeUpdate`](_reference_react_Component.md#getsnapshotbeforeupdate) instead.

[See examples of migrating away from unsafe lifecycles.](https://legacy.reactjs.org/blog/2018/03/27/update-on-async-rendering.html#examples)

#### Parameters[](_reference_react_Component.md#unsafe_componentwillupdate-parameters)

- `nextProps`: The next props that the component is about to render with. Compare `nextProps` to [`this.props`](_reference_react_Component.md#props) to determine what changed.
- `nextState`: The next state that the component is about to render with. Compare `nextState` to [`this.state`](_reference_react_Component.md#state) to determine what changed.

#### Returns[](_reference_react_Component.md#unsafe_componentwillupdate-returns)

`UNSAFE_componentWillUpdate` should not return anything.

#### Caveats[](_reference_react_Component.md#unsafe_componentwillupdate-caveats)

- `UNSAFE_componentWillUpdate` will not get called if [`shouldComponentUpdate`](_reference_react_Component.md#shouldcomponentupdate) is defined and returns `false`.
- `UNSAFE_componentWillUpdate` will not get called if the component implements [`static getDerivedStateFromProps`](_reference_react_Component.md#static-getderivedstatefromprops) or [`getSnapshotBeforeUpdate`.](_reference_react_Component.md#getsnapshotbeforeupdate)
- It’s not supported to call [`setState`](_reference_react_Component.md#setstate) (or any method that leads to `setState` being called, like dispatching a Redux action) during `componentWillUpdate`.
- Despite its naming, `UNSAFE_componentWillUpdate` does not guarantee that the component _will_ update if your app uses modern React features like [`Suspense`.](_reference_react_Suspense.md) If a render attempt is suspended (for example, because the code for some child component has not loaded yet), React will throw the in-progress tree away and attempt to construct the component from scratch during the next attempt. By the time of the next render attempt, the props and state might be different. This is why this method is “unsafe”. Code that should run only for committed updates (like resetting a subscription) should go into [`componentDidUpdate`.](_reference_react_Component.md#componentdidupdate)
...
If you want to read [`this.context`](_reference_react_Component.md#context-instance-field) from your class component, you must specify which context it needs to read. The context you specify as the `static contextType` must be a value previously created by [`createContext`.](_reference_react_createContext.md)
...
Defining `defaultProps` in class components is similar to using [default values](_learn_passing-props-to-a-component.md#specifying-a-default-value-for-a-prop) in function components.
...
Typically, it is used together with [`componentDidCatch`](_reference_react_Component.md#componentdidcatch) which lets you send the error report to some analytics service. A component with these methods is called an _error boundary._

[See an example.](_reference_react_Component.md#catching-rendering-errors-with-an-error-boundary)

#### Parameters[](_reference_react_Component.md#static-getderivedstatefromerror-parameters)

- `error`: The error that was thrown. In practice, it will usually be an instance of [`Error`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) but this is not guaranteed because JavaScript allows to [`throw`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/throw) any value, including strings or even `null`.

#### Returns[](_reference_react_Component.md#static-getderivedstatefromerror-returns)

`static getDerivedStateFromError` should return the state telling the component to display the error message.

#### Caveats[](_reference_react_Component.md#static-getderivedstatefromerror-caveats)

- `static getDerivedStateFromError` should be a pure function. If you want to perform a side effect (for example, to call an analytics service), you need to also implement [`componentDidCatch`.](_reference_react_Component.md#componentdidcatch)
...
If you define `static getDerivedStateFromProps`, React will call it right before calling [`render`,](_reference_react_Component.md#render) both on the initial mount and on subsequent updates. It should return an object to update the state, or `null` to update nothing.
...
#### Parameters[](_reference_react_Component.md#static-getderivedstatefromprops-parameters)

- `props`: The next props that the component is about to render with.
- `state`: The next state that the component is about to render with.

#### Returns[](_reference_react_Component.md#static-getderivedstatefromprops-returns)

`static getDerivedStateFromProps` return an object to update the state, or `null` to update nothing.

#### Caveats[](_reference_react_Component.md#static-getderivedstatefromprops-caveats)

- This method is fired on _every_ render, regardless of the cause. This is different from [`UNSAFE_componentWillReceiveProps`](_reference_react_Component.md#unsafe_cmoponentwillreceiveprops), which only fires when the parent causes a re-render and not as a result of a local `setState`.
...
React will call your [`render`](_reference_react_Component.md#render) method whenever it needs to figure out what to display on the screen. Usually, you will return some [JSX](_learn_writing-markup-with-jsx.md) from it. Your `render` method should be a [pure function:](https://en.wikipedia.org/wiki/Pure_function) it should only calculate the JSX.

Similarly to [function components,](_learn_your-first-component.md#defining-a-component) a class component can [receive information by props](_learn_your-first-component.md#defining-a-component) from its parent component. However, the syntax for reading props is different. For example, if the parent component renders `<Greeting name="Taylor" />`, then you can read the `name` prop from [`this.props`](_reference_react_Component.md#props), like `this.props.name`:

Note that Hooks (functions starting with `use`, like [`useState`](_reference_react_useState.md)) are not supported inside class components.
...
To add [state](_learn_state-a-components-memory.md) to a class, assign an object to a property called [`state`](_reference_react_Component.md#state). To update state, call [`this.setState`](_reference_react_Component.md#setstate).
...
If you define the [`componentDidMount`](_reference_react_Component.md#componentdidmount) method, React will call it when your component is added _(mounted)_ to the screen. React will call [`componentDidUpdate`](_reference_react_Component.md#componentdidupdate) after your component re-renders due to changed props or state. React will call [`componentWillUnmount`](_reference_react_Component.md#componentwillunmount) after your component has been removed _(unmounted)_ from the screen.

If you implement `componentDidMount`, you usually need to implement all three lifecycles to avoid bugs. For example, if `componentDidMount` reads some state or props, you also have to implement `componentDidUpdate` to handle their changes, and `componentWillUnmount` to clean up whatever `componentDidMount` was doing.

For example, this `ChatRoom` component keeps a chat connection synchronized with props and state:

Note that in development when [Strict Mode](_reference_react_StrictMode.md) is on, React will call `componentDidMount`, immediately call `componentWillUnmount`, and then call `componentDidMount` again. This helps you notice if you forgot to implement `componentWillUnmount` or if its logic doesn’t fully “mirror” what `componentDidMount` does.
...
To implement an error boundary component, you need to provide [`static getDerivedStateFromError`](_reference_react_Component.md#static-getderivedstatefromerror) which lets you update state in response to an error and display an error message to the user. You can also optionally implement [`componentDidCatch`](_reference_react_Component.md#componentdidcatch) to add some extra logic, for example, to log the error to an analytics service.

With [`captureOwnerStack`](_reference_react_captureOwnerStack.md) you can include the Owner Stack during development.
...
Typically, you will [define components as functions](_learn_your-first-component.md#defining-a-component) instead.
...
Instead of `this.props.name`, define the `name` prop [using the destructuring syntax](_learn_passing-props-to-a-component.md) and read it directly:
...
Start by declaring a function with the necessary [state variables:](_reference_react_useState.md#adding-state-to-a-component)
...
First, verify that your [`componentWillUnmount`](_reference_react_Component.md#componentwillunmount) does the opposite of [`componentDidMount`.](_reference_react_Component.md#componentdidmount) In the above example, that’s true: it disconnects the connection that `componentDidMount` sets up. If such logic is missing, add it first.
...
In this example, the `Panel` and `Button` class components read [context](_learn_passing-data-deeply-with-context.md) from [`this.context`:](_reference_react_Component.md#context)

When you convert them to function components, replace `this.context` with [`useContext`](_reference_react_useContext.md) calls:

#### \_reference_react_Fragment.md

> Source: https://react.dev/reference/react/Fragment
> Scraped: 4/22/2025, 1:21:00 PM
...
#### Props[](_reference_react_Fragment.md#props)
...
#### Caveats[](_reference_react_Fragment.md#caveats)
...
#### How to write a Fragment without the special syntax?[](_reference_react_Fragment.md#how-to-write-a-fragment-without-the-special-syntax)
...
#### Props[](_reference_react_Profiler.md#props)
...
#### Caveats[](_reference_react_Profiler.md#caveats)
...
#### Parameters[](_reference_react_Profiler.md#onrender-parameters)
...
#### \_reference_react_PureComponent.md
...
`PureComponent` is similar to [`Component`](_reference_react_Component.md) but it skips re-renders for same props and state. Class components are still supported by React, but we don’t recommend using them in new code.
...
- [Reference](_reference_react_PureComponent.md#reference)
  - [`PureComponent`](_reference_react_PureComponent.md#purecomponent)
- [Usage](_reference_react_PureComponent.md#usage)
  - [Skipping unnecessary re-renders for class components](_reference_react_PureComponent.md#skipping-unnecessary-re-renders-for-class-components)
- [Alternatives](_reference_react_PureComponent.md#alternatives)
  - [Migrating from a `PureComponent` class component to a function](_reference_react_PureComponent.md#migrating-from-a-purecomponent-class-component-to-a-function)
...
To skip re-rendering a class component for same props and state, extend `PureComponent` instead of [`Component`:](_reference_react_Component.md)
...
`PureComponent` is a subclass of `Component` and supports [all the `Component` APIs.](_reference_react_Component.md#reference) Extending `PureComponent` is equivalent to defining a custom [`shouldComponentUpdate`](_reference_react_Component.md#shouldcomponentupdate) method that shallowly compares props and state.

[See more examples below.](_reference_react_PureComponent.md#usage)
...
React normally re-renders a component whenever its parent re-renders. As an optimization, you can create a component that React will not re-render when its parent re-renders so long as its new props and state are the same as the old props and state. [Class components](_reference_react_Component.md) can opt into this behavior by extending `PureComponent`:
...
We recommend using function components instead of [class components](_reference_react_Component.md) in new code. If you have some existing class components using `PureComponent`, here is how you can convert them. This is the original code:
...
#### Props[](_reference_react_StrictMode.md#props)

`StrictMode` accepts no props.

#### Caveats[](_reference_react_StrictMode.md#caveats)
...
#### Parameters[](_reference_react_act.md#parameters)

- `async actFn`: An async function wrapping renders or interactions for components being tested. Any updates triggered within the `actFn`, are added to an internal act queue, which are then flushed together to process and apply any changes to the DOM. Since it is async, React will also run any code that crosses an async boundary, and flush any updates scheduled.

#### Returns[](_reference_react_act.md#returns)
...
In addition to [Hooks](_reference_react.md) and [Components](_reference_react_components.md), the `react` package exports a few other APIs that are useful for defining components. This page lists all the remaining modern React APIs.
...
- [`forwardRef`](_reference_react_forwardRef.md) lets your component expose a DOM node as a ref to the parent. Used with [`useRef`.](_reference_react_useRef.md)
...
## Resource APIs[](_reference_react_apis.md#resource-apis)
...
#### Caveats[](_reference_react_cache.md#caveats)

- React will invalidate the cache for all memoized functions for each server request.
- Each call to `cache` creates a new function. This means that calling `cache` with the same function multiple times will return different memoized functions that do not share the same cache.
- `cachedFn` will also cache errors. If `fn` throws an error for certain arguments, it will be cached, and the same error is re-thrown when `cachedFn` is called with those same arguments.
- `cache` is for use in [Server Components](_blog_2023_03_22_react-labs-what-we-have-been-working-on-march-2023.md#react-server-components) only.
...
#### Caching asynchronous work[](_reference_react_cache.md#caching-asynchronous-work)
...
#### When should I use `cache`, [`memo`](_reference_react_memo.md), or [`useMemo`](_reference_react_useMemo.md)?[](_reference_react_cache.md#cache-memo-usememo)
...
#### `useMemo`[](_reference_react_cache.md#deep-dive-use-memo)

In general, you should use [`useMemo`](_reference_react_useMemo.md) for caching a expensive computation in a Client Component across renders. As an example, to memoize a transformation of data within a component.
...
#### `cache`[](_reference_react_cache.md#deep-dive-cache)
...
#### `memo`[](_reference_react_cache.md#deep-dive-memo)
...
#### Parameters[](_reference_react_captureOwnerStack.md#parameters)

`captureOwnerStack` does not take any parameters.

#### Returns[](_reference_react_captureOwnerStack.md#returns)
...
#### Caveats[](_reference_react_captureOwnerStack.md#caveats)

- Owner Stacks are only available in development. `captureOwnerStack` will always return `null` outside of development.

##### Deep Dive

#### Owner Stack vs Component Stack[](_reference_react_captureOwnerStack.md#owner-stack-vs-component-stack)

The Owner Stack is different from the Component Stack available in React error handlers like [`errorInfo.componentStack` in `onUncaughtError`](_reference_react-dom_client_hydrateRoot.md#show-a-dialog-for-uncaught-errors).
...
#### \_reference_react_cloneElement.md
...
- [Reference](_reference_react_cloneElement.md#reference)
  - [`cloneElement(element, props, ...children)`](_reference_react_cloneElement.md#cloneelement)
- [Usage](_reference_react_cloneElement.md#usage)
  - [Overriding props of an element](_reference_react_cloneElement.md#overriding-props-of-an-element)
- [Alternatives](_reference_react_cloneElement.md#alternatives)
  - [Passing data with a render prop](_reference_react_cloneElement.md#passing-data-with-a-render-prop)
  - [Passing data through context](_reference_react_cloneElement.md#passing-data-through-context)
  - [Extracting logic into a custom Hook](_reference_react_cloneElement.md#extracting-logic-into-a-custom-hook)
...
[See more examples below.](_reference_react_cloneElement.md#usage)

#### Parameters[](_reference_react_cloneElement.md#parameters)

- `element`: The `element` argument must be a valid React element. For example, it could be a JSX node like `<Something />`, the result of calling [`createElement`](_reference_react_createElement.md), or the result of another `cloneElement` call.
- `props`: The `props` argument must either be an object or `null`. If you pass `null`, the cloned element will retain all of the original `element.props`. Otherwise, for every prop in the `props` object, the returned element will “prefer” the value from `props` over the value from `element.props`. The rest of the props will be filled from the original `element.props`. If you pass `props.key` or `props.ref`, they will replace the original ones.
- **optional** `...children`: Zero or more child nodes. They can be any React nodes, including React elements, strings, numbers, [portals](_reference_react-dom_createPortal.md), empty nodes (`null`, `undefined`, `true`, and `false`), and arrays of React nodes. If you don’t pass any `...children` arguments, the original `element.props.children` will be preserved.

#### Returns[](_reference_react_cloneElement.md#returns)
...
#### Caveats[](_reference_react_cloneElement.md#caveats)

- Cloning an element **does not modify the original element.** You should only **pass children as multiple arguments to `cloneElement` if they are all statically known,** like `cloneElement(element, null, child1, child2, child3)`. If your children are dynamic, pass the entire array as the third argument: `cloneElement(element, null, listItems)`. This ensures that React will [warn you about missing `key`s](_learn_rendering-lists.md#keeping-list-items-in-order-with-key) for any dynamic lists. For static lists this is not necessary because they never reorder.
- `cloneElement` makes it harder to trace the data flow, so **try the [alternatives](_reference_react_cloneElement.md#alternatives) instead.** \* \*
...
Cloning children makes it hard to tell how the data flows through your app. Try one of the [alternatives.](_reference_react_cloneElement.md#alternatives)
...
Another alternative to `cloneElement` is to [pass data through context.](_learn_passing-data-deeply-with-context.md)

For example, you can call [`createContext`](_reference_react_createContext.md) to define a `HighlightContext`:
...
[Learn more about passing data through context.](_reference_react_useContext.md#passing-data-deeply-into-the-tree)
...
## Built-in components[](_reference_react_components.md#built-in-components)
...
## Your own components[](_reference_react_components.md#your-own-components)
...
#### Parameters[](_reference_react_createContext.md#parameters)

- `defaultValue`: The value that you want the context to have when there is no matching context provider in the tree above the component that reads context. If you don’t have any meaningful default value, specify `null`. The default value is meant as a “last resort” fallback. It is static and never changes over time.

#### Returns[](_reference_react_createContext.md#returns)

`createContext` returns a context object.

**The context object itself does not hold any information.** It represents _which_ context other components read or provide. Typically, you will use [`SomeContext.Provider`](_reference_react_createContext.md#provider) in components above to specify the context value, and call [`useContext(SomeContext)`](_reference_react_useContext.md) in components below to read it. The context object has a few properties:
...
#### Props[](_reference_react_createContext.md#provider-props)
...
#### Props[](_reference_react_createContext.md#consumer-props)
...
#### \_reference_react_createElement.md

> Source: https://react.dev/reference/react/createElement
> Scraped: 4/22/2025, 1:21:13 PM

`createElement` lets you create a React element. It serves as an alternative to writing [JSX.](_learn_writing-markup-with-jsx.md)

```
const element = createElement(type, props, ...children)
```

- [Reference](_reference_react_createElement.md#reference)
  - [`createElement(type, props, ...children)`](_reference_react_createElement.md#createelement)
- [Usage](_reference_react_createElement.md#usage)
  - [Creating an element without JSX](_reference_react_createElement.md#creating-an-element-without-jsx)
...
[See more examples below.](_reference_react_createElement.md#usage)

#### Parameters[](_reference_react_createElement.md#parameters)

- `type`: The `type` argument must be a valid React component type. For example, it could be a tag name string (such as `'div'` or `'span'`), or a React component (a function, a class, or a special component like [`Fragment`](_reference_react_Fragment.md)).
...
- **optional** `...children`: Zero or more child nodes. They can be any React nodes, including React elements, strings, numbers, [portals](_reference_react-dom_createPortal.md), empty nodes (`null`, `undefined`, `true`, and `false`), and arrays of React nodes.

#### Returns[](_reference_react_createElement.md#returns)
...
#### Caveats[](_reference_react_createElement.md#caveats)
...
If you don’t like [JSX](_learn_writing-markup-with-jsx.md) or can’t use it in your project, you can use `createElement` as an alternative.
...
#### What is a React element, exactly?[](_reference_react_createElement.md#what-is-a-react-element-exactly)
...
#### \_reference_react_createFactory.md
...
- [Reference](_reference_react_createFactory.md#reference)
  - [`createFactory(type)`](_reference_react_createFactory.md#createfactory)
- [Usage](_reference_react_createFactory.md#usage)
  - [Creating React elements with a factory](_reference_react_createFactory.md#creating-react-elements-with-a-factory)
- [Alternatives](_reference_react_createFactory.md#alternatives)
  - [Copying `createFactory` into your project](_reference_react_createFactory.md#copying-createfactory-into-your-project)
  - [Replacing `createFactory` with `createElement`](_reference_react_createFactory.md#replacing-createfactory-with-createelement)
  - [Replacing `createFactory` with JSX](_reference_react_createFactory.md#replacing-createfactory-with-jsx)
...
[See more examples below.](_reference_react_createFactory.md#usage)

#### Parameters[](_reference_react_createFactory.md#parameters)

- `type`: The `type` argument must be a valid React component type. For example, it could be a tag name string (such as `'div'` or `'span'`), or a React component (a function, a class, or a special component like [`Fragment`](_reference_react_Fragment.md)).

#### Returns[](_reference_react_createFactory.md#returns)
...
Although most React projects use [JSX](_learn_writing-markup-with-jsx.md) to describe the user interface, JSX is not required. In the past, `createFactory` used to be one of the ways you could describe the user interface without JSX.
...
If you have a few `createFactory` calls that you don’t mind porting manually, and you don’t want to use JSX, you can replace every call a factory function with a [`createElement`](_reference_react_createElement.md) call. For example, you can replace this code:
...
`createRef` creates a [ref](_learn_referencing-values-with-refs.md) object which can contain arbitrary value.
...
- [Reference](_reference_react_createRef.md#reference)
  - [`createRef()`](_reference_react_createRef.md#createref)
- [Usage](_reference_react_createRef.md#usage)
  - [Declaring a ref in a class component](_reference_react_createRef.md#declaring-a-ref-in-a-class-component)
- [Alternatives](_reference_react_createRef.md#alternatives)
  - [Migrating from a class with `createRef` to a function with `useRef`](_reference_react_createRef.md#migrating-from-a-class-with-createref-to-a-function-with-useref)
...
Call `createRef` to declare a [ref](_learn_referencing-values-with-refs.md) inside a [class component.](_reference_react_Component.md)
...
[See more examples below.](_reference_react_createRef.md#usage)

#### Parameters[](_reference_react_createRef.md#parameters)

`createRef` takes no parameters.

#### Returns[](_reference_react_createRef.md#returns)

`createRef` returns an object with a single property:

- `current`: Initially, it’s set to the `null`. You can later set it to something else. If you pass the ref object to React as a `ref` attribute to a JSX node, React will set its `current` property.

#### Caveats[](_reference_react_createRef.md#caveats)

- `createRef` always returns a _different_ object. It’s equivalent to writing `{ current: null }` yourself.
- In a function component, you probably want [`useRef`](_reference_react_useRef.md) instead which always returns the same object.
...
To declare a ref inside a [class component,](_reference_react_Component.md) call `createRef` and assign its result to a class field:
...
We recommend using function components instead of [class components](_reference_react_Component.md) in new code. If you have some existing class components using `createRef`, here is how you can convert them. This is the original code:
...
#### Parameters[](_reference_react_experimental_taintObjectReference.md#parameters)

- `message`: The message you want to display if the object gets passed to a Client Component. This message will be displayed as a part of the Error that will be thrown if the object gets passed to a Client Component.
- `object`: The object to be tainted. Functions and class instances can be passed to `taintObjectReference` as `object`. Functions and classes are already blocked from being passed to Client Components but the React’s default error message will be replaced by what you defined in `message`. When a specific instance of a Typed Array is passed to `taintObjectReference` as `object`, any other copies of the Typed Array will not be tainted.

#### Returns[](_reference_react_experimental_taintObjectReference.md#returns)

`experimental_taintObjectReference` returns `undefined`.

#### Caveats[](_reference_react_experimental_taintObjectReference.md#caveats)
...
#### Protecting against leaks in data fetching[](_reference_react_experimental_taintObjectReference.md#protecting-against-leaks-in-data-fetching)
...
#### Parameters[](_reference_react_experimental_taintUniqueValue.md#parameters)
...
#### Returns[](_reference_react_experimental_taintUniqueValue.md#returns)

`experimental_taintUniqueValue` returns `undefined`.

#### Caveats[](_reference_react_experimental_taintUniqueValue.md#caveats)
...
#### Using `server-only` and `taintUniqueValue` to prevent leaking secrets[](_reference_react_experimental_taintUniqueValue.md#using-server-only-and-taintuniquevalue-to-prevent-leaking-secrets)
...
#### \_reference_react_experimental_useEffectEvent.md
...
`useEffectEvent` is a React Hook that lets you extract non-reactive logic into an [Effect Event.](_learn_separating-events-from-effects.md#declaring-an-effect-event)

```
const onSomething = useEffectEvent(callback)
```

#### \_reference_react_forwardRef.md
...
`forwardRef` will deprecated in a future release. Learn more [here](_blog_2024_04_25_react-19.md#ref-as-a-prop).

`forwardRef` lets your component expose a DOM node to parent component with a [ref.](_learn_manipulating-the-dom-with-refs.md)

```
const SomeComponent = forwardRef(render)
```

- [Reference](_reference_react_forwardRef.md#reference)
  - [`forwardRef(render)`](_reference_react_forwardRef.md#forwardref)
  - [`render` function](_reference_react_forwardRef.md#render-function)
- [Usage](_reference_react_forwardRef.md#usage)
  - [Exposing a DOM node to the parent component](_reference_react_forwardRef.md#exposing-a-dom-node-to-the-parent-component)
  - [Forwarding a ref through multiple components](_reference_react_forwardRef.md#forwarding-a-ref-through-multiple-components)
  - [Exposing an imperative handle instead of a DOM node](_reference_react_forwardRef.md#exposing-an-imperative-handle-instead-of-a-dom-node)
- [Troubleshooting](_reference_react_forwardRef.md#troubleshooting)
  - [My component is wrapped in `forwardRef`, but the `ref` to it is always `null`](_reference_react_forwardRef.md#my-component-is-wrapped-in-forwardref-but-the-ref-to-it-is-always-null)
...
[See more examples below.](_reference_react_forwardRef.md#usage)

#### Parameters[](_reference_react_forwardRef.md#parameters)

- `render`: The render function for your component. React calls this function with the props and `ref` that your component received from its parent. The JSX you return will be the output of your component.

#### Returns[](_reference_react_forwardRef.md#returns)

`forwardRef` returns a React component that you can render in JSX. Unlike React components defined as plain functions, a component returned by `forwardRef` is also able to receive a `ref` prop.

#### Caveats[](_reference_react_forwardRef.md#caveats)

- In Strict Mode, React will **call your render function twice** in order to [help you find accidental impurities.](_reference_react_useState.md#my-initializer-or-updater-function-runs-twice) This is development-only behavior and does not affect production. If your render function is pure (as it should be), this should not affect the logic of your component. The result from one of the calls will be ignored.
...
#### Parameters[](_reference_react_forwardRef.md#render-parameters)

- `props`: The props passed by the parent component.
- `ref`: The `ref` attribute passed by the parent component. The `ref` can be an object or a function. If the parent component has not passed a ref, it will be `null`. You should either pass the `ref` you receive to another component, or pass it to [`useImperativeHandle`.](_reference_react_useImperativeHandle.md)

#### Returns[](_reference_react_forwardRef.md#render-returns)
...
This `Form` component [passes a ref](_reference_react_useRef.md#manipulating-the-dom-with-a-ref) to `MyInput`. The `MyInput` component _forwards_ that ref to the `<input>` browser tag. As a result, the `Form` component can access that `<input>` DOM node and call [`focus()`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/focus) on it.

Keep in mind that exposing a ref to the DOM node inside your component makes it harder to change your component’s internals later. You will typically expose DOM nodes from reusable low-level components like buttons or text inputs, but you won’t do it for application-level components like an avatar or a comment.

#### Examples of forwarding a ref[](_reference_react_forwardRef.md#examples)

#### Focusing a text input[](_reference_react_forwardRef.md#focusing-a-text-input)
...
Pass the `ref` you received to [`useImperativeHandle`](_reference_react_useImperativeHandle.md) and specify the value you want to expose to the `ref`:
...
[Read more about using imperative handles.](_reference_react_useImperativeHandle.md)
...
## State Hooks[](_reference_react_hooks.md#state-hooks)
...
## Context Hooks[](_reference_react_hooks.md#context-hooks)
...
## Ref Hooks[](_reference_react_hooks.md#ref-hooks)
...
## Effect Hooks[](_reference_react_hooks.md#effect-hooks)
...
## Performance Hooks[](_reference_react_hooks.md#performance-hooks)
...
## Other Hooks[](_reference_react_hooks.md#other-hooks)
...
## Your own Hooks[](_reference_react_hooks.md#your-own-hooks)
...
#### \_reference_react_isValidElement.md
...
- [Reference](_reference_react_isValidElement.md#reference)
  - [`isValidElement(value)`](_reference_react_isValidElement.md#isvalidelement)
- [Usage](_reference_react_isValidElement.md#usage)
  - [Checking if something is a React element](_reference_react_isValidElement.md#checking-if-something-is-a-react-element)
...
[See more examples below.](_reference_react_isValidElement.md#usage)

#### Parameters[](_reference_react_isValidElement.md#parameters)

- `value`: The `value` you want to check. It can be any a value of any type.

#### Returns[](_reference_react_isValidElement.md#returns)

`isValidElement` returns `true` if the `value` is a React element. Otherwise, it returns `false`.

#### Caveats[](_reference_react_isValidElement.md#caveats)

- **Only [JSX tags](_learn_writing-markup-with-jsx.md) and objects returned by [`createElement`](_reference_react_createElement.md) are considered to be React elements.** For example, even though a number like `42` is a valid React _node_ (and can be returned from a component), it is not a valid React element. Arrays and portals created with [`createPortal`](_reference_react-dom_createPortal.md) are also _not_ considered to be React elements.
...
- Values produced by writing a [JSX tag](_learn_writing-markup-with-jsx.md)
- Values produced by calling [`createElement`](_reference_react_createElement.md)
...
It is very uncommon to need `isValidElement`. It’s mostly useful if you’re calling another API that _only_ accepts elements (like [`cloneElement`](_reference_react_cloneElement.md) does) and you want to avoid an error when your argument is not a React element.

Unless you have some very specific reason to add an `isValidElement` check, you probably don’t need it.

##### Deep Dive

#### React elements vs React nodes[](_reference_react_isValidElement.md#react-elements-vs-react-nodes)
...
- A portal created with [`createPortal`](_reference_react-dom_createPortal.md)
- A string
- A number
...
#### Parameters[](_reference_react_lazy.md#parameters)
...
#### Returns[](_reference_react_lazy.md#returns)
...
#### Parameters[](_reference_react_lazy.md#load-parameters)

`load` receives no parameters.

#### Returns[](_reference_react_lazy.md#load-returns)
...
## Legacy APIs[](_reference_react_legacy.md#legacy-apis)

- [`Children`](_reference_react_Children.md) lets you manipulate and transform the JSX received as the `children` prop. [See alternatives.](_reference_react_Children.md#alternatives)
- [`cloneElement`](_reference_react_cloneElement.md) lets you create a React element using another element as a starting point. [See alternatives.](_reference_react_cloneElement.md#alternatives)
- [`Component`](_reference_react_Component.md) lets you define a React component as a JavaScript class. [See alternatives.](_reference_react_Component.md#alternatives)
- [`createElement`](_reference_react_createElement.md) lets you create a React element. Typically, you’ll use JSX instead.
- [`createRef`](_reference_react_createRef.md) creates a ref object which can contain arbitrary value. [See alternatives.](_reference_react_createRef.md#alternatives)
- [`forwardRef`](_reference_react_forwardRef.md) lets your component expose a DOM node to parent component with a [ref.](_learn_manipulating-the-dom-with-refs.md)
- [`isValidElement`](_reference_react_isValidElement.md) checks whether a value is a React element. Typically used with [`cloneElement`.](_reference_react_cloneElement.md)
- [`PureComponent`](_reference_react_PureComponent.md) is similar to [`Component`,](_reference_react_Component.md) but it skip re-renders with same props. [See alternatives.](_reference_react_PureComponent.md#alternatives)

---

## Removed APIs[](_reference_react_legacy.md#removed-apis)

These APIs were removed in React 19:

- [`createFactory`](https://18.react.dev/reference/react/createFactory): use JSX instead.
- Class Components: [`static contextTypes`](https://18.react.dev//reference/react/Component#static-contexttypes): use [`static contextType`](_reference_react_legacy.md#static-contexttype) instead.
- Class Components: [`static childContextTypes`](https://18.react.dev//reference/react/Component#static-childcontexttypes): use [`static contextType`](_reference_react_legacy.md#static-contexttype) instead.
- Class Components: [`static getChildContext`](https://18.react.dev//reference/react/Component#getchildcontext): use [`Context.Provider`](_reference_react_createContext.md#provider) instead.
- Class Components: [`static propTypes`](https://18.react.dev//reference/react/Component#static-proptypes): use a type system like [TypeScript](https://www.typescriptlang.org/) instead.
- Class Components: [`this.refs`](https://18.react.dev//reference/react/Component#refs): use [`createRef`](_reference_react_createRef.md) instead.
...
#### Parameters[](_reference_react_memo.md#parameters)
...
#### Returns[](_reference_react_memo.md#returns)
...
#### Should you add memo everywhere?[](_reference_react_memo.md#should-you-add-memo-everywhere)
...
#### Parameters[](_reference_react_use.md#parameters)
...
#### Returns[](_reference_react_use.md#returns)
...
#### Caveats[](_reference_react_use.md#caveats)
...
#### Should I resolve a Promise in a Server or Client Component?[](_reference_react_use.md#resolve-promise-in-server-or-client-component)
...
But using `await` in a [Server Component](_reference_react_components.md#server-components) will block its rendering until the `await` statement is finished. Passing a Promise from a Server Component to a Client Component prevents the Promise from blocking the rendering of the Server Component.
...
#### Displaying an error to users with an error boundary[](_reference_react_use.md#displaying-an-error-to-users-with-error-boundary)
...
#### Providing an alternative value with `Promise.catch`[](_reference_react_use.md#providing-an-alternative-value-with-promise-catch)
...
#### Parameters[](_reference_react_useActionState.md#parameters)
...
#### Returns[](_reference_react_useActionState.md#returns)
...
#### Caveats[](_reference_react_useActionState.md#caveats)
...
#### Parameters[](_reference_react_useCallback.md#parameters)
...
#### Returns[](_reference_react_useCallback.md#returns)

On the initial render, `useCallback` returns the `fn` function you have passed.

During subsequent renders, it will either return an already stored `fn` function from the last render (if the dependencies haven’t changed), or return the `fn` function you have passed during this render.

#### Caveats[](_reference_react_useCallback.md#caveats)
...
#### Should you add useCallback everywhere?[](_reference_react_useCallback.md#should-you-add-usecallback-everywhere)
...
#### Parameters[](_reference_react_useContext.md#parameters)
...
#### Returns[](_reference_react_useContext.md#returns)
...
#### Caveats[](_reference_react_useContext.md#caveats)
...
#### Examples of updating context[](_reference_react_useContext.md#examples-basic)

#### Updating a value via context[](_reference_react_useContext.md#updating-a-value-via-context)
...
#### Examples of overriding context[](_reference_react_useContext.md#examples)

#### Overriding a theme[](_reference_react_useContext.md#overriding-a-theme)
...
2.  You may have forgotten to wrap your component with `<SomeContext.Provider>`, or you might have put it in a different part of the tree than you thought. Check whether the hierarchy is right using [React DevTools.](_learn_react-developer-tools.md)
...
#### Parameters[](_reference_react_useDebugValue.md#parameters)

- `value`: The value you want to display in React DevTools. It can have any type.
- **optional** `format`: A formatting function. When the component is inspected, React DevTools will call the formatting function with the `value` as the argument, and then display the returned formatted value (which may have any type). If you don’t specify the formatting function, the original `value` itself will be displayed.

#### Returns[](_reference_react_useDebugValue.md#returns)
...
#### Parameters[](_reference_react_useDeferredValue.md#parameters)
...
#### Returns[](_reference_react_useDeferredValue.md#returns)
...
#### Caveats[](_reference_react_useDeferredValue.md#caveats)
...
#### How does deferring a value work under the hood?[](_reference_react_useDeferredValue.md#how-does-deferring-a-value-work-under-the-hood)
...
#### The difference between useDeferredValue and unoptimized re-rendering[](_reference_react_useDeferredValue.md#examples)

#### Deferred re-rendering of the list[](_reference_react_useDeferredValue.md#deferred-re-rendering-of-the-list)
...
#### How is deferring a value different from debouncing and throttling?[](_reference_react_useDeferredValue.md#how-is-deferring-a-value-different-from-debouncing-and-throttling)
...
#### Parameters[](_reference_react_useEffect.md#parameters)
...
- **optional** `dependencies`: The list of all reactive values referenced inside of the `setup` code. Reactive values include props, state, and all the variables and functions declared directly inside your component body. If your linter is [configured for React](_learn_editor-setup.md#linting), it will verify that every reactive value is correctly specified as a dependency. The list of dependencies must have a constant number of items and be written inline like `[dep1, dep2, dep3]`. React will compare each dependency with its previous value using the [`Object.is`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/is) comparison. If you omit this argument, your Effect will re-run after every re-render of the component. [See the difference between passing an array of dependencies, an empty array, and no dependencies at all.](_reference_react_useEffect.md#examples-dependencies)

#### Returns[](_reference_react_useEffect.md#returns)

`useEffect` returns `undefined`.

#### Caveats[](_reference_react_useEffect.md#caveats)
...
#### Examples of connecting to an external system[](_reference_react_useEffect.md#examples-connecting)

#### Connecting to a chat server[](_reference_react_useEffect.md#connecting-to-a-chat-server)
...
#### Examples of wrapping Effects in custom Hooks[](_reference_react_useEffect.md#examples-custom-hooks)

#### Custom `useChatRoom` Hook[](_reference_react_useEffect.md#custom-usechatroom-hook)
...
You can use an Effect to fetch data for your component. Note that [if you use a framework,](_learn_start-a-new-react-project.md#production-grade-react-frameworks) using your framework’s data fetching mechanism will be a lot more efficient than writing Effects manually.
...
#### What are good alternatives to data fetching in Effects?[](_reference_react_useEffect.md#what-are-good-alternatives-to-data-fetching-in-effects)
...
- **If you use a [framework](_learn_start-a-new-react-project.md#production-grade-react-frameworks), use its built-in data fetching mechanism.** Modern React frameworks have integrated data fetching mechanisms that are efficient and don’t suffer from the above pitfalls.
...
#### Examples of passing reactive dependencies[](_reference_react_useEffect.md#examples-dependencies)

#### Passing a dependency array[](_reference_react_useEffect.md#passing-a-dependency-array)
...
If your Effect depends on an object or a function created during rendering, it might run too often. For example, this Effect re-connects after every render because the `options` object is [different for every render:](_learn_removing-effect-dependencies.md#does-some-reactive-value-change-unintentionally)
...
If your Effect depends on an object or a function created during rendering, it might run too often. For example, this Effect re-connects after every render because the `createOptions` function is [different for every render:](_learn_removing-effect-dependencies.md#does-some-reactive-value-change-unintentionally)
...
#### Parameters[](_reference_react_useId.md#parameters)

`useId` does not take any parameters.

#### Returns[](_reference_react_useId.md#returns)

`useId` returns a unique ID string associated with this particular `useId` call in this particular component.

#### Caveats[](_reference_react_useId.md#caveats)
...
#### Why is useId better than an incrementing counter?[](_reference_react_useId.md#why-is-useid-better-than-an-incrementing-counter)
...
#### Parameters[](_reference_react_useImperativeHandle.md#parameters)
...
#### Returns[](_reference_react_useImperativeHandle.md#returns)
...
#### Parameters[](_reference_react_useInsertionEffect.md#parameters)

- `setup`: The function with your Effect’s logic. Your setup function may also optionally return a _cleanup_ function. When your component is added to the DOM, but before any layout Effects fire, React will run your setup function. After every re-render with changed dependencies, React will first run the cleanup function (if you provided it) with the old values, and then run your setup function with the new values. When your component is removed from the DOM, React will run your cleanup function.
- **optional** `dependencies`: The list of all reactive values referenced inside of the `setup` code. Reactive values include props, state, and all the variables and functions declared directly inside your component body. If your linter is [configured for React](_learn_editor-setup.md#linting), it will verify that every reactive value is correctly specified as a dependency. The list of dependencies must have a constant number of items and be written inline like `[dep1, dep2, dep3]`. React will compare each dependency with its previous value using the [`Object.is`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/is) comparison algorithm. If you don’t specify the dependencies at all, your Effect will re-run after every re-render of the component.

#### Returns[](_reference_react_useInsertionEffect.md#returns)

`useInsertionEffect` returns `undefined`.

#### Caveats[](_reference_react_useInsertionEffect.md#caveats)
...
#### How is this better than injecting styles during rendering or useLayoutEffect?[](_reference_react_useInsertionEffect.md#how-is-this-better-than-injecting-styles-during-rendering-or-uselayouteffect)

If you insert styles during rendering and React is processing a [non-blocking update,](_reference_react_useTransition.md#marking-a-state-update-as-a-non-blocking-transition) the browser will recalculate the styles every single frame while rendering a component tree, which can be **extremely slow.**
...
#### Parameters[](_reference_react_useLayoutEffect.md#parameters)
...
#### Returns[](_reference_react_useLayoutEffect.md#returns)

`useLayoutEffect` returns `undefined`.

#### Caveats[](_reference_react_useLayoutEffect.md#caveats)
...
#### useLayoutEffect vs useEffect[](_reference_react_useLayoutEffect.md#examples)

#### `useLayoutEffect` blocks the browser from repainting[](_reference_react_useLayoutEffect.md#uselayouteffect-blocks-the-browser-from-repainting)
...
#### Parameters[](_reference_react_useMemo.md#parameters)
...
#### Returns[](_reference_react_useMemo.md#returns)

On the initial render, `useMemo` returns the result of calling `calculateValue` with no arguments.

During next renders, it will either return an already stored value from the last render (if the dependencies haven’t changed), or call `calculateValue` again, and return the result that `calculateValue` has returned.

#### Caveats[](_reference_react_useMemo.md#caveats)
...
#### How to tell if a calculation is expensive?[](_reference_react_useMemo.md#how-to-tell-if-a-calculation-is-expensive)
...
#### Should you add useMemo everywhere?[](_reference_react_useMemo.md#should-you-add-usememo-everywhere)
...
#### Memoizing individual JSX nodes[](_reference_react_useMemo.md#memoizing-individual-jsx-nodes)
...
#### Parameters[](_reference_react_useOptimistic.md#parameters)

- `state`: the value to be returned initially and whenever no action is pending.
- `updateFn(currentState, optimisticValue)`: a function that takes the current state and the optimistic value passed to `addOptimistic` and returns the resulting optimistic state. It must be a pure function. `updateFn` takes in two parameters. The `currentState` and the `optimisticValue`. The return value will be the merged value of the `currentState` and `optimisticValue`.

#### Returns[](_reference_react_useOptimistic.md#returns)
...
#### Caveats[](_reference_react_useReducer.md#caveats)
...
#### Parameters[](_reference_react_useReducer.md#dispatch-parameters)

- `action`: The action performed by the user. It can be a value of any type. By convention, an action is usually an object with a `type` property identifying it and, optionally, other properties with additional information.

#### Returns[](_reference_react_useReducer.md#dispatch-returns)

`dispatch` functions do not have a return value.

#### Caveats[](_reference_react_useReducer.md#setstate-caveats)
...
#### Parameters[](_reference_react_useRef.md#parameters)

- `initialValue`: The value you want the ref object’s `current` property to be initially. It can be a value of any type. This argument is ignored after the initial render.

#### Returns[](_reference_react_useRef.md#returns)
...
#### Caveats[](_reference_react_useRef.md#caveats)
...
#### Examples of referencing a value with useRef[](_reference_react_useRef.md#examples-value)

#### Click counter[](_reference_react_useRef.md#click-counter)
...
#### Examples of manipulating the DOM with useRef[](_reference_react_useRef.md#examples-dom)

#### Focusing a text input[](_reference_react_useRef.md#focusing-a-text-input)
...
#### How to avoid null checks when initializing useRef later[](_reference_react_useRef.md#how-to-avoid-null-checks-when-initializing-use-ref-later)
...
And then add `ref` to the list of props your component accepts and pass `ref` as a prop to the relevent child [built-in component](_reference_react-dom_components_common.md) like this:
...
#### Parameters[](_reference_react_useState.md#parameters)
...
#### Returns[](_reference_react_useState.md#returns)
...
#### Caveats[](_reference_react_useState.md#caveats)
...
#### Parameters[](_reference_react_useState.md#setstate-parameters)

- `nextState`: The value that you want the state to be. It can be a value of any type, but there is a special behavior for functions.
  - If you pass a function as `nextState`, it will be treated as an _updater function_. It must be pure, should take the pending state as its only argument, and should return the next state. React will put your updater function in a queue and re-render your component. During the next render, React will calculate the next state by applying all of the queued updaters to the previous state. [See an example below.](_reference_react_useState.md#updating-state-based-on-the-previous-state)

#### Returns[](_reference_react_useState.md#setstate-returns)

`set` functions do not have a return value.

#### Caveats[](_reference_react_useState.md#setstate-caveats)
...
#### Basic useState examples[](_reference_react_useState.md#examples-basic)

#### Counter (number)[](_reference_react_useState.md#counter-number)
...
#### Is using an updater always preferred?[](_reference_react_useState.md#is-using-an-updater-always-preferred)
...
#### The difference between passing an updater and passing the next state directly[](_reference_react_useState.md#examples-updater)

#### Passing the updater function[](_reference_react_useState.md#passing-the-updater-function)
...
#### Examples of objects and arrays in state[](_reference_react_useState.md#examples-objects)

#### Form (object)[](_reference_react_useState.md#form-object)
...
#### The difference between passing an initializer and passing the initial state directly[](_reference_react_useState.md#examples-initializer)

#### Passing the initializer function[](_reference_react_useState.md#passing-the-initializer-function)
...
#### Parameters[](_reference_react_useSyncExternalStore.md#parameters)
...
#### Returns[](_reference_react_useSyncExternalStore.md#returns)

The current snapshot of the store which you can use in your rendering logic.

#### Caveats[](_reference_react_useSyncExternalStore.md#caveats)
...
#### Parameters[](_reference_react_useTransition.md#parameters)

`useTransition` does not take any parameters.

#### Returns[](_reference_react_useTransition.md#returns)
...
#### Functions called in `startTransition` are called “Actions”.[](_reference_react_useTransition.md#functions-called-in-starttransition-are-called-actions)
...
#### Parameters[](_reference_react_useTransition.md#starttransition-parameters)

- `action`: A function that updates some state by calling one or more [`set` functions](_reference_react_useState.md#setstate). React calls `action` immediately with no parameters and marks all state updates scheduled synchronously during the `action` function call as Transitions. Any async calls that are awaited in the `action` will be included in the Transition, but currently require wrapping any `set` functions after the `await` in an additional `startTransition` (see [Troubleshooting](_reference_react_useTransition.md#react-doesnt-treat-my-state-update-after-await-as-a-transition)). State updates marked as Transitions will be [non-blocking](_reference_react_useTransition.md#marking-a-state-update-as-a-non-blocking-transition) and [will not display unwanted loading indicators](_reference_react_useTransition.md#preventing-unwanted-loading-indicators).

#### Returns[](_reference_react_useTransition.md#starttransition-returns)

`startTransition` does not return anything.

#### Caveats[](_reference_react_useTransition.md#starttransition-caveats)
...
#### The difference between Actions and regular event handling[](_reference_react_useTransition.md#examples)

#### Updating the quantity in an Action[](_reference_react_useTransition.md#updating-the-quantity-in-an-action)
...
- [Transitions are interruptible,](_reference_react_useTransition.md#marking-a-state-update-as-a-non-blocking-transition) which lets the user click away without waiting for the re-render to complete.
