...
### `codeFrameColumns`[​](_docs_babel-code-frame.md#codeframecolumns)
...
## Credits[​](_docs_babel-parser.md#credits)
...
Added `createParenthesizedExpressions`
...
`regexpUnicodeSets` ([proposal](https://github.com/tc39/proposal-regexp-set-notation))
...
```
## Usage[​](_docs_babel-plugin-proposal-function-sent.md#usage)
...
#### _docs_babel-plugin-proposal-partial-application.md
...
### With a configuration file (Recommended)[​](_docs_babel-plugin-proposal-partial-application.md#with-a-configuration-file-recommended)
...
### With a configuration file (recommended)[​](_docs_babel-plugin-proposal-pipeline-operator.md#with-a-configuration-file-recommended)
...
#### _docs_babel-plugin-proposal-record-and-tuple.md

> Source: https://babeljs.io/docs/babel-plugin-proposal-record-and-tuple
> Scraped: 3/31/2025, 2:29:04 PM

## Installation[​](_docs_babel-plugin-proposal-record-and-tuple.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-proposal-record-and-tuple.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-proposal-record-and-tuple.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-proposal-record-and-tuple.md#via-cli)

Shell
```
$ babel --plugins @babel/plugin-proposal-record-and-tuple script.js  
```
### Via Node API[​](_docs_babel-plugin-proposal-record-and-tuple.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: [["@babel/plugin-proposal-record-and-tuple"]],});  
```
## Options[​](_docs_babel-plugin-proposal-record-and-tuple.md#options)

### `importPolyfill`[​](_docs_babel-plugin-proposal-record-and-tuple.md#importpolyfill)
...
```
{  
  "plugins": [    [      "@babel/plugin-proposal-record-and-tuple",      {        "importPolyfill": true      }    ]  ]}  
```
JavaScript
```
let a = #[1, 2, 3];  
...
### `polyfillModuleName`[​](_docs_babel-plugin-proposal-record-and-tuple.md#polyfillmodulename)
...
## References[​](_docs_babel-plugin-proposal-record-and-tuple.md#references)
*   [Proposal: JavaScript Records & Tuples](https://github.com/tc39/proposal-record-tuple)

#### _docs_babel-plugin-proposal-throw-expressions.md

> Source: https://babeljs.io/docs/babel-plugin-proposal-throw-expressions
> Scraped: 3/31/2025, 2:29:04 PM

## Example[​](_docs_babel-plugin-proposal-throw-expressions.md#example)
...
```
## Installation[​](_docs_babel-plugin-proposal-throw-expressions.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-proposal-throw-expressions.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-proposal-throw-expressions.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-proposal-throw-expressions.md#via-cli)

Shell
```
babel --plugins @babel/plugin-proposal-throw-expressions script.js  
```
### Via Node API[​](_docs_babel-plugin-proposal-throw-expressions.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-proposal-throw-expressions"],});  
```
## References[​](_docs_babel-plugin-proposal-throw-expressions.md#references)
*   [Proposal: ECMAScript throw expressions](https://github.com/tc39/proposal-throw-expressions)

#### _docs_babel-plugin-syntax-bigint.md

> Source: https://babeljs.io/docs/babel-plugin-syntax-bigint
> Scraped: 3/31/2025, 2:29:33 PM
...
#### Syntax only[​](_docs_babel-plugin-syntax-bigint.md#syntax-only)
...
## Installation[​](_docs_babel-plugin-syntax-bigint.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-syntax-bigint.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-syntax-bigint.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-syntax-bigint.md#via-cli)

Shell
```
babel --plugins @babel/plugin-syntax-bigint script.js  
```
### Via Node API[​](_docs_babel-plugin-syntax-bigint.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-syntax-bigint"],});  
```
## References[​](_docs_babel-plugin-syntax-bigint.md#references)
...
#### _docs_babel-plugin-syntax-dynamic-import.md

> Source: https://babeljs.io/docs/babel-plugin-syntax-dynamic-import
> Scraped: 3/31/2025, 2:29:35 PM
...
## Installation[​](_docs_babel-plugin-syntax-dynamic-import.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-syntax-dynamic-import.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-syntax-dynamic-import.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-syntax-dynamic-import.md#via-cli)

Shell
```
babel --plugins @babel/plugin-syntax-dynamic-import script.js  
```
### Via Node API[​](_docs_babel-plugin-syntax-dynamic-import.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-syntax-dynamic-import"],});  
```
## Working with Webpack and @babel/preset-env[​](_docs_babel-plugin-syntax-dynamic-import.md#working-with-webpack-and-babelpreset-env)
...
```
const config = {  
  entry: [    "core-js/modules/es.promise",    "core-js/modules/es.array.iterator",    path.resolve(__dirname, "src/main.js"),  ],  // ...};  
```
or
...
```
const config = {  
  entry: [    "core-js/modules/es6.promise",    "core-js/modules/es6.array.iterator",    path.resolve(__dirname, "src/main.js"),  ],  // ...};  
```
or
...
#### _docs_babel-plugin-syntax-import-meta.md

> Source: https://babeljs.io/docs/babel-plugin-syntax-import-meta
> Scraped: 3/31/2025, 2:29:35 PM
...
## Installation[​](_docs_babel-plugin-syntax-import-meta.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-syntax-import-meta.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-syntax-import-meta.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-syntax-import-meta.md#via-cli)

Shell
```
babel --plugins @babel/plugin-syntax-import-meta script.js  
```
### Via Node API[​](_docs_babel-plugin-syntax-import-meta.md#via-node-api)
...
#### _docs_babel-plugin-syntax-jsx.md

> Source: https://babeljs.io/docs/babel-plugin-syntax-jsx
> Scraped: 3/31/2025, 2:29:37 PM

note

#### Syntax only[​](_docs_babel-plugin-syntax-jsx.md#syntax-only)

Using this plugin directly only enables Babel to parse this syntax. If you want to transform JSX syntax then use the [transform-react-jsx](_docs_babel-plugin-transform-react-jsx.md) plugin or [react](_docs_babel-preset-react.md) preset to _both_ parse and transform this syntax.

## Installation[​](_docs_babel-plugin-syntax-jsx.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-syntax-jsx.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-syntax-jsx.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-syntax-jsx.md#via-cli)

Shell
```
babel --plugins @babel/plugin-syntax-jsx script.js  
```
### Via Node API[​](_docs_babel-plugin-syntax-jsx.md#via-node-api)
...
#### _docs_babel-plugin-syntax-top-level-await.md

> Source: https://babeljs.io/docs/babel-plugin-syntax-top-level-await
> Scraped: 3/31/2025, 2:29:35 PM
...
#### Syntax only[​](_docs_babel-plugin-syntax-top-level-await.md#syntax-only)
...
export { val };  
```
## Installation[​](_docs_babel-plugin-syntax-top-level-await.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-syntax-top-level-await.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-syntax-top-level-await.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-syntax-top-level-await.md#via-cli)

Shell
```
babel --plugins @babel/plugin-syntax-top-level-await script.js  
```
### Via Node API[​](_docs_babel-plugin-syntax-top-level-await.md#via-node-api)
...
#### _docs_babel-plugin-transform-arrow-functions.md

> Source: https://babeljs.io/docs/babel-plugin-transform-arrow-functions
> Scraped: 3/31/2025, 2:29:15 PM

```
var _this = this;  
  
var a = function a() {  
  babelHelpers.newArrowCheck(this, _this);}.bind(this);  
var a = function a(b) {  
  babelHelpers.newArrowCheck(this, _this);  return b;}.bind(this);  
  
const double = [1, 2, 3].map(  
  function(num) {    babelHelpers.newArrowCheck(this, _this);    return num * 2;  }.bind(this));  
console.log(double); // [2,4,6]  
  
var bob = {  
  _name: "Bob",  _friends: ["Sally", "Tom"],  printFriends() {    var _this2 = this;  
    this._friends.forEach(      function(f) {        babelHelpers.newArrowCheck(this, _this2);        return console.log(this._name + " knows " + f);      }.bind(this)    );  },};  
console.log(bob.printFriends());  
```

#### _docs_babel-plugin-transform-async-generator-functions.md

> Source: https://babeljs.io/docs/babel-plugin-transform-async-generator-functions
> Scraped: 3/31/2025, 2:29:11 PM

info

This plugin is included in `@babel/preset-env`, in [ES2018](https://github.com/tc39/proposals/blob/master/finished-proposals.md)

## Example[​](_docs_babel-plugin-transform-async-generator-functions.md#example)
...
let agf = (() => {  
  var _ref = _asyncGenerator.wrap(function* () {    yield _asyncGenerator.await(1);    yield 2;  });  
  return function agf() {    return _ref.apply(this, arguments);  };})();  
```
For await example
...
async function* genAnswers() {  
  var stream = [Promise.resolve(4), Promise.resolve(9), Promise.resolve(12)];  var total = 0;  for await (let val of stream) {    total += await val;    yield total;  }}  
  
function forEach(ai, fn) {  
  return ai.next().then(function(r) {    if (!r.done) {      fn(r);      return forEach(ai, fn);    }  });}  
  
var output = 0;  
forEach(genAnswers(), function(val) {  
  output += val.value;}).then(function() {  
...
## Installation[​](_docs_babel-plugin-transform-async-generator-functions.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-async-generator-functions.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-async-generator-functions.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-async-generator-functions.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-async-generator-functions script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-async-generator-functions.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-async-generator-functions"],});  
```
## References[​](_docs_babel-plugin-transform-async-generator-functions.md#references)
*   [Proposal: Asynchronous iteration for ECMAScript](https://github.com/tc39/proposal-async-iteration)

#### _docs_babel-plugin-transform-async-to-generator.md

> Source: https://babeljs.io/docs/babel-plugin-transform-async-to-generator
> Scraped: 3/31/2025, 2:29:13 PM
...
## Example[​](_docs_babel-plugin-transform-async-to-generator.md#example)
...
> Turn async functions into a Bluebird coroutine ([caveats](_docs_babel-plugin-transform-async-to-generator.md#bluebird-non-promise-runtime-error))
...
var foo = Bluebird.coroutine(function*() {  
  yield bar();});  
```
## Installation[​](_docs_babel-plugin-transform-async-to-generator.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-async-to-generator.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-async-to-generator.md#with-a-configuration-file-recommended)
...
```
{  
  "plugins": [    [      "@babel/plugin-transform-async-to-generator",      {        "module": "bluebird",        "method": "coroutine"      }    ]  ]}  
```
### Via CLI[​](_docs_babel-plugin-transform-async-to-generator.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-async-to-generator script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-async-to-generator.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-async-to-generator"],});  
```
## Caveats[​](_docs_babel-plugin-transform-async-to-generator.md#caveats)

### Bluebird non-promise runtime error[​](_docs_babel-plugin-transform-async-to-generator.md#bluebird-non-promise-runtime-error)
...
```
## References[​](_docs_babel-plugin-transform-async-to-generator.md#references)
*   [Proposal: Async Functions for ECMAScript](https://github.com/tc39/ecmascript-asyncawait)

#### _docs_babel-plugin-transform-block-scoped-functions.md

> Source: https://babeljs.io/docs/babel-plugin-transform-block-scoped-functions
> Scraped: 3/31/2025, 2:29:15 PM
...
## Examples[​](_docs_babel-plugin-transform-block-scoped-functions.md#examples)
...
```
{  
  let name = function(n) {    return n;  };}  
name("Steve");  
```
## Installation[​](_docs_babel-plugin-transform-block-scoped-functions.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-block-scoped-functions.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-block-scoped-functions.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-block-scoped-functions.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-block-scoped-functions script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-block-scoped-functions.md#via-node-api)
...
#### _docs_babel-plugin-transform-block-scoping.md

> Source: https://babeljs.io/docs/babel-plugin-transform-block-scoping
> Scraped: 3/31/2025, 2:29:15 PM
...
## Examples[​](_docs_babel-plugin-transform-block-scoping.md#examples)

**In***Out**

## Constant checks[​](_docs_babel-plugin-transform-block-scoping.md#constant-checks)
...
## Installation[​](_docs_babel-plugin-transform-block-scoping.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-block-scoping.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-block-scoping.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-block-scoping.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-block-scoping script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-block-scoping.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-block-scoping"],});  
```
## Options[​](_docs_babel-plugin-transform-block-scoping.md#options)

### `throwIfClosureRequired`[​](_docs_babel-plugin-transform-block-scoping.md#throwifclosurerequired)
...
### `tdz`[​](_docs_babel-plugin-transform-block-scoping.md#tdz)
...
#### _docs_babel-plugin-transform-class-properties.md

> Source: https://babeljs.io/docs/babel-plugin-transform-class-properties
> Scraped: 3/31/2025, 2:29:06 PM

info

This plugin is included in `@babel/preset-env`, in [ES2022](https://github.com/tc39/proposals/blob/master/finished-proposals.md)

## Example[​](_docs_babel-plugin-transform-class-properties.md#example)
...
```
class Bork {  
  //Property initializer syntax  instanceProperty = "bork";  boundFunction = () => {    return this.instanceProperty;  };  
  //Static class properties  static staticProperty = "babelIsCool";  static staticFunction = function() {    return Bork.staticProperty;  };}  
...
```
## Installation[​](_docs_babel-plugin-transform-class-properties.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-class-properties.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-class-properties.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-class-properties.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-class-properties script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-class-properties.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-class-properties"],});  
```
## Options[​](_docs_babel-plugin-transform-class-properties.md#options)

### `loose`[​](_docs_babel-plugin-transform-class-properties.md#loose)
...
#### Example[​](_docs_babel-plugin-transform-class-properties.md#example-1)

JavaScript
```
class Bork {  
  static a = "foo";  static b;  
  x = "bar";  y;}  
```
...
var Bork = function Bork() {  
  babelHelpers.classCallCheck(this, Bork);  Object.defineProperty(this, "x", {    configurable: true,    enumerable: true,    writable: true,    value: "bar",  });  Object.defineProperty(this, "y", {    configurable: true,    enumerable: true,    writable: true,    value: void 0,  });};  
  
Object.defineProperty(Bork, "a", {  
  configurable: true,  enumerable: true,  writable: true,  value: "foo",});  
Object.defineProperty(Bork, "b", {  
  configurable: true,  enumerable: true,  writable: true,  value: void 0,});  
```
...
```
var Bork = function Bork() {  
  babelHelpers.classCallCheck(this, Bork);  this.x = "bar";  this.y = void 0;};  
...
## References[​](_docs_babel-plugin-transform-class-properties.md#references)
...
#### _docs_babel-plugin-transform-class-static-block.md

> Source: https://babeljs.io/docs/babel-plugin-transform-class-static-block
> Scraped: 3/31/2025, 2:29:06 PM
...
## Example[​](_docs_babel-plugin-transform-class-static-block.md#example)

JavaScript
```
class C {  
  static #x = 42;  static y;  static {    try {      this.y = doSomethingWith(this.#x);    } catch {      this.y = "unknown";    }  }}  
```
will be transformed to
...
```
class C {  
  static #x = 42;  static y;  static #_ = (() => {    try {      this.y = doSomethingWith(this.#x);    } catch {      this.y = "unknown";    }  })();}  
```
Because the output code includes private class properties, if you are already using other class feature plugins (e.g. [`@babel/plugin-transform-class-properties`](_docs_babel-plugin-transform-class-properties.md)), be sure to place it _before_ the others.

babel.config.json
```
{  
  "plugins": [    "@babel/plugin-transform-class-static-block",    "@babel/plugin-transform-class-properties"  ]}  
```
## Installation[​](_docs_babel-plugin-transform-class-static-block.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-class-static-block.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-class-static-block.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-class-static-block.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-class-static-block script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-class-static-block.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-class-static-block"],});  
```
## References[​](_docs_babel-plugin-transform-class-static-block.md#references)
*   [Proposal: Class Static Block](https://github.com/tc39/proposal-class-static-block)

#### _docs_babel-plugin-transform-classes.md

> Source: https://babeljs.io/docs/babel-plugin-transform-classes
> Scraped: 3/31/2025, 2:29:15 PM
...
## Caveats[​](_docs_babel-plugin-transform-classes.md#caveats)
...
```
## Examples[​](_docs_babel-plugin-transform-classes.md#examples)
...
class Test {  
  ...
  logger() {    console.log("Hello", this.name);  }}  
```
**Out**
...
var Test = (function() {  
  function Test(name) {    _classCallCheck(this, Test);  
    this.name = name;  }  
  Test.prototype.logger = function logger() {    console.log("Hello", this.name);  };  
  return Test;})();  
```
## Installation[​](_docs_babel-plugin-transform-classes.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-classes.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-classes.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-classes.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-classes script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-classes.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-classes"],});  
```
## Options[​](_docs_babel-plugin-transform-classes.md#options)

### `loose`[​](_docs_babel-plugin-transform-classes.md#loose)

`boolean`, defaults to `false`.

caution

Consider migrating to the top level [`assumptions`](_docs_assumptions.md) which offers granular control over various `loose` mode deductions Babel has applied.

babel.config.json
```
{  
  "assumptions": {    "constantSuper": true,    "noClassCalls": true,    "setClassMethods": true,    "superIsCallableConstructor": true  }}  
```
#### Method enumerability[​](_docs_babel-plugin-transform-classes.md#method-enumerability)
...
#### Method assignment[​](_docs_babel-plugin-transform-classes.md#method-assignment)
...
```
class Foo {  
  set bar() {    throw new Error("foo!");  }}  
  
class Bar extends Foo {  
  bar() {    // will throw an error when this method is defined  }}  
```
...
#### _docs_babel-plugin-transform-computed-properties.md

> Source: https://babeljs.io/docs/babel-plugin-transform-computed-properties
> Scraped: 3/31/2025, 2:29:15 PM
...
#### _docs_babel-plugin-transform-destructuring.md

> Source: https://babeljs.io/docs/babel-plugin-transform-destructuring
> Scraped: 3/31/2025, 2:29:17 PM

info

This plugin is included in `@babel/preset-env`

## Examples[​](_docs_babel-plugin-transform-destructuring.md#examples)
...
let _obj = obj,  
    x = _obj.x,    y = _obj.y;  
let _arr = arr,  
    _arr2 = _toArray(_arr),    a = _arr2[0],    b = _arr2[1],    rest = _arr2.slice(2);
```
## Installation[​](_docs_babel-plugin-transform-destructuring.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-destructuring.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-destructuring.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-destructuring.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-destructuring script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-destructuring.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-destructuring"],});  
```
## Options[​](_docs_babel-plugin-transform-destructuring.md#options)

### `loose`[​](_docs_babel-plugin-transform-destructuring.md#loose)
...
```
### `useBuiltIns`[​](_docs_babel-plugin-transform-destructuring.md#usebuiltins)

`boolean`, defaults to `false`.

Enabling this option will use `Object.assign` directly instead of the Babel's `extends` helper.

##### Example[​](_docs_babel-plugin-transform-destructuring.md#example)
...
### `allowArrayLike`[​](_docs_babel-plugin-transform-destructuring.md#allowarraylike)
...
```
## References[​](_docs_babel-plugin-transform-destructuring.md#references)
*   [MDN: Destructuring assignment](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment)

#### _docs_babel-plugin-transform-dotall-regex.md

> Source: https://babeljs.io/docs/babel-plugin-transform-dotall-regex
> Scraped: 3/31/2025, 2:29:11 PM
...
## Example[​](_docs_babel-plugin-transform-dotall-regex.md#example)
...
## Installation[​](_docs_babel-plugin-transform-dotall-regex.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-dotall-regex.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-dotall-regex.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-dotall-regex.md#via-cli)

Shell
```
$ babel --plugins @babel/plugin-transform-dotall-regex script.js  
```
### Via Node.js API[​](_docs_babel-plugin-transform-dotall-regex.md#via-nodejs-api)
...
#### _docs_babel-plugin-transform-duplicate-keys.md

> Source: https://babeljs.io/docs/babel-plugin-transform-duplicate-keys
> Scraped: 3/31/2025, 2:29:17 PM
...
This plugin actually converts duplicate keys in objects to be computed properties, which then must be handled by the [@babel/plugin-transform-computed-properties](_docs_babel-plugin-transform-computed-properties.md) plugin. The final result won't contain any object literals with duplicate keys.

## Example[​](_docs_babel-plugin-transform-duplicate-keys.md#example)
...
var y = {  
  get a() {},  set a(x) {},  ["a"]: 3,};  
```
## Installation[​](_docs_babel-plugin-transform-duplicate-keys.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-duplicate-keys.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-duplicate-keys.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-duplicate-keys.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-duplicate-keys script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-duplicate-keys.md#via-node-api)
...
#### _docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md

> Source: https://babeljs.io/docs/babel-plugin-transform-duplicate-named-capturing-groups-regex
> Scraped: 3/31/2025, 2:29:04 PM
...
## Examples[​](_docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md#examples)
...
console.log(re.exec("02-1999").groups.year);  
```
## Installation[​](_docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-duplicate-named-capturing-groups-regex script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-duplicate-named-capturing-groups-regex"],});  
```
## Options[​](_docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md#options)

### `runtime`[​](_docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md#runtime)
...
## References[​](_docs_babel-plugin-transform-duplicate-named-capturing-groups-regex.md#references)
*   [Proposal: Duplicate named capturing groups](https://github.com/tc39/proposal-duplicate-named-capturing-groups)

#### _docs_babel-plugin-transform-dynamic-import.md

> Source: https://babeljs.io/docs/babel-plugin-transform-dynamic-import
> Scraped: 3/31/2025, 2:29:08 PM
...
## When (not) to use this plugin[​](_docs_babel-plugin-transform-dynamic-import.md#when-not-to-use-this-plugin)
...
*   You are authoring a Node.js library in ESM but want to distribute it in CommonJS(CJS): Install this plugin and [`@babel/plugin-transform-modules-commonjs`](_docs_babel-plugin-transform-modules-commonjs.md)
*   You use [RequireJS](https://requirejs.org/) to load modules in the browser: Install this plugin and [`@babel/plugin-transform-modules-amd`](_docs_babel-plugin-transform-modules-amd.md)
*   You use [SystemJS](https://github.com/systemjs/systemjs) to load modules in the browser: Install this plugin and [`@babel/plugin-transform-modules-systemjs`](_docs_babel-plugin-transform-modules-systemjs.md)

This plugin must be used with one of the module transform plugins mentioned above.

## Example[​](_docs_babel-plugin-transform-dynamic-import.md#example)
...
```
Promise.resolve()  
  .then(() => _interopRequireWildcard(require("jquery")))  .then(($) => {});
```
## Installation[​](_docs_babel-plugin-transform-dynamic-import.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-dynamic-import.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-dynamic-import.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-dynamic-import.md#via-cli)

Shell
```
babel --plugins=@babel/plugin-transform-dynamic-import,@babel/plugin-transform-modules-amd script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-dynamic-import.md#via-node-api)

JavaScript
```
require("@babel/core").transformSync("code", {  
  plugins: [    "@babel/plugin-transform-dynamic-import",    "@babel/plugin-transform-modules-systemjs"  ],});  
```
## References[​](_docs_babel-plugin-transform-dynamic-import.md#references)
*   [Proposal: import()](https://github.com/tc39/proposal-dynamic-import)

#### _docs_babel-plugin-transform-exponentiation-operator.md

> Source: https://babeljs.io/docs/babel-plugin-transform-exponentiation-operator
> Scraped: 3/31/2025, 2:29:13 PM
...
## Example[​](_docs_babel-plugin-transform-exponentiation-operator.md#example)
...
x = Math.pow(x, 3);  
```
## Installation[​](_docs_babel-plugin-transform-exponentiation-operator.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-exponentiation-operator.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-exponentiation-operator.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-exponentiation-operator.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-exponentiation-operator script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-exponentiation-operator.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-exponentiation-operator"],});  
```
## References[​](_docs_babel-plugin-transform-exponentiation-operator.md#references)
...
#### _docs_babel-plugin-transform-export-namespace-from.md

> Source: https://babeljs.io/docs/babel-plugin-transform-export-namespace-from
> Scraped: 3/31/2025, 2:29:09 PM

info

This plugin is included in `@babel/preset-env`, in [ES2020](https://github.com/tc39/proposals/blob/master/finished-proposals.md)

## Example[​](_docs_babel-plugin-transform-export-namespace-from.md#example)

JavaScript
```
export * as ns from "mod";  
```
## Installation[​](_docs_babel-plugin-transform-export-namespace-from.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-export-namespace-from.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-export-namespace-from.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-export-namespace-from.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-export-namespace-from script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-export-namespace-from.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-export-namespace-from"],});  
```
## References[​](_docs_babel-plugin-transform-export-namespace-from.md#references)
*   [Proposal: Additional export-from statements in ES7](https://github.com/leebyron/ecmascript-more-export-from) (Withdrawn)
*   [ECMAScript Proposal: export ns from](https://github.com/leebyron/ecmascript-export-ns-from)

#### _docs_babel-plugin-transform-flow-strip-types.md

> Source: https://babeljs.io/docs/babel-plugin-transform-flow-strip-types
> Scraped: 3/31/2025, 2:29:30 PM
...
## Example[​](_docs_babel-plugin-transform-flow-strip-types.md#example)
...
```
## Installation[​](_docs_babel-plugin-transform-flow-strip-types.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-flow-strip-types.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-flow-strip-types.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-flow-strip-types.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-flow-strip-types script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-flow-strip-types.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-flow-strip-types"],});  
```
## Options[​](_docs_babel-plugin-transform-flow-strip-types.md#options)

### `all`[​](_docs_babel-plugin-transform-flow-strip-types.md#all)
...
### `requireDirective`[​](_docs_babel-plugin-transform-flow-strip-types.md#requiredirective)
...
### `allowDeclareFields`[​](_docs_babel-plugin-transform-flow-strip-types.md#allowdeclarefields)
...
#### _docs_babel-plugin-transform-for-of.md

> Source: https://babeljs.io/docs/babel-plugin-transform-for-of
> Scraped: 3/31/2025, 2:29:17 PM
...
## Example[​](_docs_babel-plugin-transform-for-of.md#example)
...
try {  
  for (    var _iterator = foo[Symbol.iterator](), _step;    !(_iteratorNormalCompletion = (_step = _iterator.next()).done);    _iteratorNormalCompletion = true  ) {    var i = _step.value;  }} catch (err) {  
  _didIteratorError = true;  _iteratorError = err;} finally {  
...
```
## Installation[​](_docs_babel-plugin-transform-for-of.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-for-of.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-for-of.md#with-a-configuration-file-recommended)
...
```
{  
  "plugins": [    ["@babel/plugin-transform-for-of", {      "loose": true, // defaults to false      "assumeArray": true // defaults to false    }]  ]}  
```
### Via CLI[​](_docs_babel-plugin-transform-for-of.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-for-of script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-for-of.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-for-of"],});  
```
## Options[​](_docs_babel-plugin-transform-for-of.md#options)

### `loose`[​](_docs_babel-plugin-transform-for-of.md#loose)
...
#### Example[​](_docs_babel-plugin-transform-for-of.md#example-1)
...
```
for (  
  var _iterator = foo,    _isArray = Array.isArray(_iterator),    _i = 0,    _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();  ;  
) {  
  var _ref;  
  if (_isArray) {    if (_i >= _iterator.length) break;    _ref = _iterator[_i++];  } else {    _i = _iterator.next();    if (_i.done) break;    _ref = _i.value;  }  
  var i = _ref;}  
```
#### Abrupt completions[​](_docs_babel-plugin-transform-for-of.md#abrupt-completions)
...
### `allowArrayLike`[​](_docs_babel-plugin-transform-for-of.md#allowarraylike)
...
### `assumeArray`[​](_docs_babel-plugin-transform-for-of.md#assumearray)
...
### Optimization[​](_docs_babel-plugin-transform-for-of.md#optimization)
...
#### _docs_babel-plugin-transform-function-name.md

> Source: https://babeljs.io/docs/babel-plugin-transform-function-name
> Scraped: 3/31/2025, 2:29:17 PM
...
## Examples[​](_docs_babel-plugin-transform-function-name.md#examples)
...
var number = function number(x) {  
  return x;};  
```
## Installation[​](_docs_babel-plugin-transform-function-name.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-function-name.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-function-name.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-function-name.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-function-name script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-function-name.md#via-node-api)
...
#### _docs_babel-plugin-transform-instanceof.md

> Source: https://babeljs.io/docs/babel-plugin-transform-instanceof
> Scraped: 3/31/2025, 2:29:17 PM

## Example[​](_docs_babel-plugin-transform-instanceof.md#example)
...
_instanceof(foo, Bar);  
```
## Installation[​](_docs_babel-plugin-transform-instanceof.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-instanceof.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-instanceof.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-instanceof.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-instanceof script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-instanceof.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-instanceof"],});  
```
## References[​](_docs_babel-plugin-transform-instanceof.md#references)
...
#### _docs_babel-plugin-transform-jscript.md

> Source: https://babeljs.io/docs/babel-plugin-transform-jscript
> Scraped: 3/31/2025, 2:29:30 PM

## Example[​](_docs_babel-plugin-transform-jscript.md#example)
...
var foo = (function() {  
  ...
  return bar;})();  
```
## Installation[​](_docs_babel-plugin-transform-jscript.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-jscript.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-jscript.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-jscript.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-jscript script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-jscript.md#via-node-api)
...
#### _docs_babel-plugin-transform-json-modules.md

> Source: https://babeljs.io/docs/babel-plugin-transform-json-modules
> Scraped: 3/31/2025, 2:29:04 PM
...
## Example[​](_docs_babel-plugin-transform-json-modules.md#example)
...
```
## Installation[​](_docs_babel-plugin-transform-json-modules.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-json-modules.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-json-modules.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-json-modules.md#via-cli)

Shell
```
babel --plugins=@babel/plugin-transform-json-modules script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-json-modules.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-json-modules"],});  
```
## Options[​](_docs_babel-plugin-transform-json-modules.md#options)

### `uncheckedRequire`[​](_docs_babel-plugin-transform-json-modules.md#uncheckedrequire)
...
```
## References[​](_docs_babel-plugin-transform-json-modules.md#references)
*   [Proposal: JSON Modules](https://github.com/tc39/proposal-json-modules/)

#### _docs_babel-plugin-transform-json-strings.md

> Source: https://babeljs.io/docs/babel-plugin-transform-json-strings
> Scraped: 3/31/2025, 2:29:11 PM
...
## Examples[​](_docs_babel-plugin-transform-json-strings.md#examples)
...
//                ^ There's a U+2028 char between 'before' and 'after'  
```
## Installation[​](_docs_babel-plugin-transform-json-strings.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-json-strings.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-json-strings.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-json-strings.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-json-strings script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-json-strings.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-json-strings"],});  
```
## References[​](_docs_babel-plugin-transform-json-strings.md#references)
*   [Proposal: Subsume JSON strings](https://github.com/babel/proposals/issues/43)

#### _docs_babel-plugin-transform-literals.md

> Source: https://babeljs.io/docs/babel-plugin-transform-literals
> Scraped: 3/31/2025, 2:29:19 PM

info

This plugin is included in `@babel/preset-env`

## Example[​](_docs_babel-plugin-transform-literals.md#example)
...
```
## Installation[​](_docs_babel-plugin-transform-literals.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-literals.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-literals.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-literals.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-literals script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-literals.md#via-node-api)
...
#### _docs_babel-plugin-transform-logical-assignment-operators.md

> Source: https://babeljs.io/docs/babel-plugin-transform-logical-assignment-operators
> Scraped: 3/31/2025, 2:29:08 PM
...
## Example[​](_docs_babel-plugin-transform-logical-assignment-operators.md#example)
...
```
### With Nullish Coalescing[​](_docs_babel-plugin-transform-logical-assignment-operators.md#with-nullish-coalescing)
...
(_obj$a$b = (_obj$a = obj.a).b) !== null && _obj$a$b !== void 0  
  ? _obj$a$b  : (_obj$a.b = c);
```
## Installation[​](_docs_babel-plugin-transform-logical-assignment-operators.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-logical-assignment-operators.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-logical-assignment-operators.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-logical-assignment-operators.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-logical-assignment-operators script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-logical-assignment-operators.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-logical-assignment-operators"],});  
```
## References[​](_docs_babel-plugin-transform-logical-assignment-operators.md#references)
*   [Proposal: Logical Assignment Operators](https://github.com/tc39/proposal-logical-assignment)

#### _docs_babel-plugin-transform-member-expression-literals.md

> Source: https://babeljs.io/docs/babel-plugin-transform-member-expression-literals
> Scraped: 3/31/2025, 2:29:23 PM

info

This plugin is included in `@babel/preset-env`

## Example[​](_docs_babel-plugin-transform-member-expression-literals.md#example)
...
obj["var"] = "isKeyword";  
```
## Installation[​](_docs_babel-plugin-transform-member-expression-literals.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-member-expression-literals.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-member-expression-literals.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-member-expression-literals.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-member-expression-literals script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-member-expression-literals.md#via-node-api)
...
#### _docs_babel-plugin-transform-modules-amd.md

> Source: https://babeljs.io/docs/babel-plugin-transform-modules-amd
> Scraped: 3/31/2025, 2:29:25 PM
...
Implemented the `importInterop` option
...
## Example[​](_docs_babel-plugin-transform-modules-amd.md#example)
...
define(["exports"], function(exports) {  
  ...
  exports.default = 42;});  
```
## Installation[​](_docs_babel-plugin-transform-modules-amd.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-modules-amd.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-modules-amd.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-modules-amd.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-modules-amd script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-modules-amd.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-modules-amd"],});  
```
## Options[​](_docs_babel-plugin-transform-modules-amd.md#options)

### `moduleIds`[​](_docs_babel-plugin-transform-modules-amd.md#moduleids)
...
### `moduleId`[​](_docs_babel-plugin-transform-modules-amd.md#moduleid)
...
### `getModuleId`[​](_docs_babel-plugin-transform-modules-amd.md#getmoduleid)
...
### `moduleRoot`[​](_docs_babel-plugin-transform-modules-amd.md#moduleroot)
...
For options not listed here, see options for [`@babel/plugin-transform-modules-commonjs`](_docs_babel-plugin-transform-modules-commonjs.md#options).

#### _docs_babel-plugin-transform-modules-commonjs.md

> Source: https://babeljs.io/docs/babel-plugin-transform-modules-commonjs
> Scraped: 3/31/2025, 2:29:26 PM
...
## Example[​](_docs_babel-plugin-transform-modules-commonjs.md#example)
...
exports.default = 42;  
```
## Installation[​](_docs_babel-plugin-transform-modules-commonjs.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-modules-commonjs.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-modules-commonjs.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-modules-commonjs.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-modules-commonjs script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-modules-commonjs.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-modules-commonjs"],});  
```
## Options[​](_docs_babel-plugin-transform-modules-commonjs.md#options)

### `importInterop`[​](_docs_babel-plugin-transform-modules-commonjs.md#importinterop)
...
#### `"babel"`[​](_docs_babel-plugin-transform-modules-commonjs.md#babel)
...
#### `"node"`[​](_docs_babel-plugin-transform-modules-commonjs.md#node)
...
#### `"none"`[​](_docs_babel-plugin-transform-modules-commonjs.md#none)
...
_bar.bar;  
```
### `loose`[​](_docs_babel-plugin-transform-modules-commonjs.md#loose)
...
```
### `strict`[​](_docs_babel-plugin-transform-modules-commonjs.md#strict)
...
### `lazy`[​](_docs_babel-plugin-transform-modules-commonjs.md#lazy)
...
### `noInterop`[​](_docs_babel-plugin-transform-modules-commonjs.md#nointerop)
...
## Relevant [`assumptions`](_docs_en_assumptions.md)[​](_docs_babel-plugin-transform-modules-commonjs.md#relevant-assumptions)
*   [`enumerableModuleMeta`](_docs_en_assumptions.md#enumerablemodulemeta)
*   [`noIncompleteNsImportDetection`](_docs_en_assumptions.md#noincompletensimportdetection)

#### _docs_babel-plugin-transform-modules-systemjs.md

> Source: https://babeljs.io/docs/babel-plugin-transform-modules-systemjs
> Scraped: 3/31/2025, 2:29:26 PM
...
## Example[​](_docs_babel-plugin-transform-modules-systemjs.md#example)
...
System.register([], function(_export, _context) {  
  return {    setters: [],    execute: function() {      _export("default", 42);    },  };});  
```
For dynamic import support (`import('./lazy.js').then(m => ...)`), enable the [@babel/plugin-syntax-dynamic-import](_docs_babel-plugin-syntax-dynamic-import.md) plugin before this one.

## Installation[​](_docs_babel-plugin-transform-modules-systemjs.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-modules-systemjs.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-modules-systemjs.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-modules-systemjs.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-modules-systemjs script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-modules-systemjs.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-modules-systemjs"],});  
```
## Options[​](_docs_babel-plugin-transform-modules-systemjs.md#options)

### `moduleIds`[​](_docs_babel-plugin-transform-modules-systemjs.md#moduleids)
...
### `moduleId`[​](_docs_babel-plugin-transform-modules-systemjs.md#moduleid)
...
### `getModuleId`[​](_docs_babel-plugin-transform-modules-systemjs.md#getmoduleid)
...
### `moduleRoot`[​](_docs_babel-plugin-transform-modules-systemjs.md#moduleroot)
...
#### _docs_babel-plugin-transform-modules-umd.md

> Source: https://babeljs.io/docs/babel-plugin-transform-modules-umd
> Scraped: 3/31/2025, 2:29:26 PM
...
## Example[​](_docs_babel-plugin-transform-modules-umd.md#example)
...
(function(global, factory) {  
  if (typeof define === "function" && define.amd) {    define(["exports"], factory);  } else if (typeof exports !== "undefined") {    factory(exports);  } else {    var mod = {      exports: {},    };    factory(mod.exports);    global.actual = mod.exports;  }})(this, function(exports) {  
  "use strict";  
  Object.defineProperty(exports, "__esModule", {    value: true,  });  
  exports.default = 42;});  
```
## Installation[​](_docs_babel-plugin-transform-modules-umd.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-modules-umd.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-modules-umd.md#with-a-configuration-file-recommended)
...
```
{  
  "plugins": [    [      "@babel/plugin-transform-modules-umd",      {        "globals": {          "es6-promise": "Promise"        }      }    ]  ]}  
```
#### Default semantics[​](_docs_babel-plugin-transform-modules-umd.md#default-semantics)
...
```
{  
  "globals": {    "foo-bar": "fooBAR",    "./mylib/foo-bar": "mylib.fooBar"  }}  
```
...
_Second_, the specified override will still be passed to the `toIdentifier` function in [babel-types/src/converters](https://github.com/babel/babel/blob/main/packages/babel-types/src/converters). This means that if you specify an override as a member expression like:

JSON
```
{  
  "globals": {    "fizzbuzz": "fizz.buzz"  }}  
```
this will _not_ transpile to `factory(global.fizz.buzz)`. Instead, it will transpile to `factory(global.fizzBuzz)` based on the logic in `toIdentifier`.

_Third_, you cannot override the exported global name.

#### More flexible semantics with `exactGlobals: true`[​](_docs_babel-plugin-transform-modules-umd.md#more-flexible-semantics-with-exactglobals-true)
...
```
{  
  "globals": {    "foo-bar": "fooBAR",    "./mylib/foo-bar": "mylib.fooBar"  },  "exactGlobals": true}  
```
...
```
{  
  "plugins": [    "@babel/plugin-external-helpers",    [      "@babel/plugin-transform-modules-umd",      {        "globals": {          "my/custom/module/name": "My.Custom.Module.Name"        },        "exactGlobals": true      }    ]  ],  "moduleId": "my/custom/module/name"}  
```
...
```
### Via CLI[​](_docs_babel-plugin-transform-modules-umd.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-modules-umd script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-modules-umd.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-modules-umd"],});  
```
## Options[​](_docs_babel-plugin-transform-modules-umd.md#options)

### `moduleIds`[​](_docs_babel-plugin-transform-modules-umd.md#moduleids)
...
### `moduleId`[​](_docs_babel-plugin-transform-modules-umd.md#moduleid)
...
### `getModuleId`[​](_docs_babel-plugin-transform-modules-umd.md#getmoduleid)
...
### `moduleRoot`[​](_docs_babel-plugin-transform-modules-umd.md#moduleroot)
...
#### _docs_babel-plugin-transform-named-capturing-groups-regex.md

> Source: https://babeljs.io/docs/babel-plugin-transform-named-capturing-groups-regex
> Scraped: 3/31/2025, 2:29:13 PM

info

This plugin is included in `@babel/preset-env`, in [ES2018](https://github.com/tc39/proposals/blob/master/finished-proposals.md) NOTE: This plugin generates code that needs ES6 regular expressions functionalities. If you need to support older browsers, use either the `runtime: false` option or import a proper polyfill (e.g. `core-js`).
...
## Examples[​](_docs_babel-plugin-transform-named-capturing-groups-regex.md#examples)
...
console.log(re.exec("1999-02-29").groups.year);  
```
## Installation[​](_docs_babel-plugin-transform-named-capturing-groups-regex.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-named-capturing-groups-regex.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-named-capturing-groups-regex.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-named-capturing-groups-regex.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-named-capturing-groups-regex script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-named-capturing-groups-regex.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-named-capturing-groups-regex"],});  
```
## Options[​](_docs_babel-plugin-transform-named-capturing-groups-regex.md#options)

### `runtime`[​](_docs_babel-plugin-transform-named-capturing-groups-regex.md#runtime)
...
#### _docs_babel-plugin-transform-new-target.md

> Source: https://babeljs.io/docs/babel-plugin-transform-new-target
> Scraped: 3/31/2025, 2:29:19 PM
...
## Example[​](_docs_babel-plugin-transform-new-target.md#example)
...
new Bar(); // => Bar  
```
### Caveats[​](_docs_babel-plugin-transform-new-target.md#caveats)
...
class Bar extends Foo {  
  constructor() {    // This will be a problem if classes aren't transformed to ES5    new.target;    super();  }}  
```
...
```
## Installation[​](_docs_babel-plugin-transform-new-target.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-new-target.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-new-target.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-new-target.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-new-target script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-new-target.md#via-node-api)
...
#### _docs_babel-plugin-transform-nullish-coalescing-operator.md

> Source: https://babeljs.io/docs/babel-plugin-transform-nullish-coalescing-operator
> Scraped: 3/31/2025, 2:29:08 PM
...
## Example[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#example)
...
var foo =  
  (_object$foo = object.foo) !== null && _object$foo !== void 0    ? _object$foo    : "default";
```
note

We cannot use `!= null` here because `document.all == null` and `document.all` has been deemed not "nullish".

## Installation[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-nullish-coalescing-operator script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-nullish-coalescing-operator"],});  
```
## Options[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#options)

### `loose`[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#loose)
...
Consider migrating to the top level [`noDocumentAll`](_docs_assumptions.md#nodocumentall) assumption.
...
```
#### Example[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#example-1)
...
## References[​](_docs_babel-plugin-transform-nullish-coalescing-operator.md#references)
*   [Proposal: Nullish Coalescing](https://github.com/tc39-transfer/proposal-nullish-coalescing)

#### _docs_babel-plugin-transform-numeric-separator.md

> Source: https://babeljs.io/docs/babel-plugin-transform-numeric-separator
> Scraped: 3/31/2025, 2:29:08 PM
...
#### _docs_babel-plugin-transform-object-assign.md

> Source: https://babeljs.io/docs/babel-plugin-transform-object-assign
> Scraped: 3/31/2025, 2:29:31 PM

## Example[​](_docs_babel-plugin-transform-object-assign.md#example)
...
_extends(a, b);  
```
## Caveats[​](_docs_babel-plugin-transform-object-assign.md#caveats)
...
## Installation[​](_docs_babel-plugin-transform-object-assign.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-object-assign.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-object-assign.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-object-assign.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-object-assign script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-object-assign.md#via-node-api)
...
#### _docs_babel-plugin-transform-object-rest-spread.md

> Source: https://babeljs.io/docs/babel-plugin-transform-object-rest-spread
> Scraped: 3/31/2025, 2:29:13 PM
...
## Example[​](_docs_babel-plugin-transform-object-rest-spread.md#example)

### Rest Properties[​](_docs_babel-plugin-transform-object-rest-spread.md#rest-properties)
...
```
### Spread Properties[​](_docs_babel-plugin-transform-object-rest-spread.md#spread-properties)
...
```
## Installation[​](_docs_babel-plugin-transform-object-rest-spread.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-object-rest-spread.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-object-rest-spread.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-object-rest-spread.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-object-rest-spread script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-object-rest-spread.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-object-rest-spread"],});  
```
## Options[​](_docs_babel-plugin-transform-object-rest-spread.md#options)

By default, this plugin will produce spec compliant code by using Babel's `objectSpread` helper.

### `loose`[​](_docs_babel-plugin-transform-object-rest-spread.md#loose)
...
### `useBuiltIns`[​](_docs_babel-plugin-transform-object-rest-spread.md#usebuiltins)

`boolean`, defaults to `false`.

Enabling this option will use `Object.assign` directly instead of the Babel's `extends` helper.

##### Example[​](_docs_babel-plugin-transform-object-rest-spread.md#example-1)
...
```
{  
  "assumptions": {    "setSpreadProperties": true  },  "plugins": [    ["@babel/plugin-transform-object-rest-spread", { "useBuiltIns": true }]  ]}  
```
**In***Out**
...
## References[​](_docs_babel-plugin-transform-object-rest-spread.md#references)
...
#### _docs_babel-plugin-transform-object-set-prototype-of-to-assign.md

> Source: https://babeljs.io/docs/babel-plugin-transform-object-set-prototype-of-to-assign
> Scraped: 3/31/2025, 2:29:32 PM

**NOTE:** There are some caveats when using this plugin, see the [`@babel/plugin-transform-proto-to-assign`](_docs_babel-plugin-transform-proto-to-assign.md) docs for more information.

## Example[​](_docs_babel-plugin-transform-object-set-prototype-of-to-assign.md#example)
...
_defaults(bar, foo);  
```
## Installation[​](_docs_babel-plugin-transform-object-set-prototype-of-to-assign.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-object-set-prototype-of-to-assign.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-object-set-prototype-of-to-assign.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-object-set-prototype-of-to-assign.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-object-set-prototype-of-to-assign script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-object-set-prototype-of-to-assign.md#via-node-api)
...
#### _docs_babel-plugin-transform-object-super.md

> Source: https://babeljs.io/docs/babel-plugin-transform-object-super
> Scraped: 3/31/2025, 2:29:19 PM
...
var obj = {  
  say: function say() {    return "Hello";  },};  
  
var obj2 = (_obj = {  
  say: function say() {    return (      _get(_obj.__proto__ || Object.getPrototypeOf(_obj), "say", this).call(        this      ) + "World!"    );  },});  
```

#### _docs_babel-plugin-transform-optional-catch-binding.md

> Source: https://babeljs.io/docs/babel-plugin-transform-optional-catch-binding
> Scraped: 3/31/2025, 2:29:10 PM

info

This plugin is included in `@babel/preset-env`, in [ES2019](https://github.com/tc39/proposals/blob/master/finished-proposals.md)

## Examples[​](_docs_babel-plugin-transform-optional-catch-binding.md#examples)
...
try {  
  throw 0;} catch {  
  doSomethingWhichDoesNotCareAboutTheValueThrown();} finally {  
  doSomeCleanup();}  
```
## Installation[​](_docs_babel-plugin-transform-optional-catch-binding.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-optional-catch-binding.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-optional-catch-binding.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-optional-catch-binding.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-optional-catch-binding script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-optional-catch-binding.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-optional-catch-binding"],});  
```
## References[​](_docs_babel-plugin-transform-optional-catch-binding.md#references)
*   [Proposal: Optional Catch Binding for ECMAScript](https://github.com/babel/proposals/issues/7)

#### _docs_babel-plugin-transform-optional-chaining.md

> Source: https://babeljs.io/docs/babel-plugin-transform-optional-chaining
> Scraped: 3/31/2025, 2:29:10 PM
...
## Example[​](_docs_babel-plugin-transform-optional-chaining.md#example)

### Accessing deeply nested properties[​](_docs_babel-plugin-transform-optional-chaining.md#accessing-deeply-nested-properties)
...
obj?.["foo"]?.bar?.baz; // 42  
```
### Calling deeply nested functions[​](_docs_babel-plugin-transform-optional-chaining.md#calling-deeply-nested-functions)

JavaScript
```
const obj = {  
  foo: {    bar: {      baz() {        return 42;      },    },  },};  
...
exists?.(); // undefined  
```
### Constructing deeply nested classes[​](_docs_babel-plugin-transform-optional-chaining.md#constructing-deeply-nested-classes)
...
```
### Deleting deeply nested properties[​](_docs_babel-plugin-transform-optional-chaining.md#deleting-deeply-nested-properties)
...
```
## Installation[​](_docs_babel-plugin-transform-optional-chaining.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-optional-chaining.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-optional-chaining.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-optional-chaining.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-optional-chaining script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-optional-chaining.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-optional-chaining"],});  
```
## Options[​](_docs_babel-plugin-transform-optional-chaining.md#options)

### `loose`[​](_docs_babel-plugin-transform-optional-chaining.md#loose)
...
{  
  "assumptions": {    "noDocumentAll": true  }}  
```
#### Example[​](_docs_babel-plugin-transform-optional-chaining.md#example-1)
...
## References[​](_docs_babel-plugin-transform-optional-chaining.md#references)
*   [Proposal: Optional Chaining](https://github.com/tc39/proposal-optional-chaining)

#### _docs_babel-plugin-transform-parameters.md

> Source: https://babeljs.io/docs/babel-plugin-transform-parameters
> Scraped: 3/31/2025, 2:29:19 PM
...
## Examples[​](_docs_babel-plugin-transform-parameters.md#examples)
...
```
function test() {  
  var x =    arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "hello";  var _ref = arguments[1];  var a = _ref.a,    b = _ref.b;  
  for (    var _len = arguments.length,      args = Array(_len > 2 ? _len - 2 : 0),      _key = 2;    _key < _len;    _key++  ) {    args[_key - 2] = arguments[_key];  }  
  console.log(x, a, b, args);}  
```
## Installation[​](_docs_babel-plugin-transform-parameters.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Caveats[​](_docs_babel-plugin-transform-parameters.md#caveats)

Default parameters desugar into `let` declarations to retain proper semantics. If this is not supported in your environment then you'll need the [@babel/plugin-transform-block-scoping](_docs_babel-plugin-transform-block-scoping.md) plugin.

## Usage[​](_docs_babel-plugin-transform-parameters.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-parameters.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-parameters.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-parameters script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-parameters.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-parameters"],});  
```
## Options[​](_docs_babel-plugin-transform-parameters.md#options)

### `loose`[​](_docs_babel-plugin-transform-parameters.md#loose)
...
#### _docs_babel-plugin-transform-private-methods.md

> Source: https://babeljs.io/docs/babel-plugin-transform-private-methods
> Scraped: 3/31/2025, 2:29:06 PM
...
Support private accessors (getters and setters)

`v7.2.0`

Initial Release

## Example[​](_docs_babel-plugin-transform-private-methods.md#example)

JavaScript
```
class Counter extends HTMLElement {  
  #xValue = 0;  
  get #x() {    return this.#xValue;  }  set #x(value) {    this.#xValue = value;    window.requestAnimationFrame(this.#render.bind(this));  }  
  #clicked() {    this.#x++;  }}  
```
## Installation[​](_docs_babel-plugin-transform-private-methods.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-private-methods.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-private-methods.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-private-methods.md#via-cli)

Shell
```
$ babel --plugins @babel/plugin-transform-private-methods script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-private-methods.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-private-methods"],});  
```
## Options[​](_docs_babel-plugin-transform-private-methods.md#options)

### `loose`[​](_docs_babel-plugin-transform-private-methods.md#loose)
...
```
{  
  "assumptions": {    "privateFieldsAsProperties": true,    "setPublicClassFields": true  }}  
```
...
```
class Foo {  
  constructor() {    this.publicField = this.#privateMethod();  }  
...
var Foo = function Foo() {  
  "use strict";  
  babelHelpers.classCallCheck(this, Foo);  Object.defineProperty(this, _privateMethod, {    value: _privateMethod2,  });  this.publicField = babelHelpers    .classPrivateFieldLooseBase(this, _privateMethod)    [_privateMethod]();};  
...
## References[​](_docs_babel-plugin-transform-private-methods.md#references)
*   [Proposal: Private methods and getter/setters for JavaScript classes](https://github.com/tc39/proposal-private-methods)

#### _docs_babel-plugin-transform-private-property-in-object.md

> Source: https://babeljs.io/docs/babel-plugin-transform-private-property-in-object
> Scraped: 3/31/2025, 2:29:06 PM
...
## Example[​](_docs_babel-plugin-transform-private-property-in-object.md#example)
...
```
class Foo {  
  constructor() {    _bar.set(this, {      writable: true,      value: "bar",    });  }  
  test() {    return _bar.has(this);  }}  
  
var _bar = new WeakMap();  
```
## Installation[​](_docs_babel-plugin-transform-private-property-in-object.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-private-property-in-object.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-private-property-in-object.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-private-property-in-object.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-private-property-in-object  
```
### Via Node API[​](_docs_babel-plugin-transform-private-property-in-object.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-private-property-in-object"],});  
```
## Options[​](_docs_babel-plugin-transform-private-property-in-object.md#options)

### `loose`[​](_docs_babel-plugin-transform-private-property-in-object.md#loose)
...
#### Example[​](_docs_babel-plugin-transform-private-property-in-object.md#example-1)
...
```
class Foo {  
  constructor() {    Object.defineProperty(this, _bar, {      writable: true,      value: "bar",    });  }  
  test() {    return Object.prototype.hasOwnProperty.call(this, _bar);  }}  
...
## References[​](_docs_babel-plugin-transform-private-property-in-object.md#references)
*   [Proposal: Ergonomic brand checks for Private Fields](https://github.com/tc39/proposal-private-fields-in-in)

#### _docs_babel-plugin-transform-property-literals.md

> Source: https://babeljs.io/docs/babel-plugin-transform-property-literals
> Scraped: 3/31/2025, 2:29:24 PM

info

This plugin is included in `@babel/preset-env`

## Example[​](_docs_babel-plugin-transform-property-literals.md#example)
...
```
var foo = {  
  // changed  const: function() {},  var: function() {},  
  // not changed  "default": 1,  [a]: 2,  foo: 1,};  
```
**Out**
...
```
var foo = {  
  "const": function() {},  "var": function() {},  
  "default": 1,  [a]: 2,  foo: 1,};  
```
## Installation[​](_docs_babel-plugin-transform-property-literals.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-property-literals.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-property-literals.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-property-literals.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-property-literals script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-property-literals.md#via-node-api)
...
#### _docs_babel-plugin-transform-property-mutators.md

> Source: https://babeljs.io/docs/babel-plugin-transform-property-mutators
> Scraped: 3/31/2025, 2:29:23 PM
...
## Example[​](_docs_babel-plugin-transform-property-mutators.md#example)
...
```
var foo = {  
  get bar() {    return this._bar;  },  set bar(value) {    this._bar = value;  },};  
```
**Out**
...
var foo = Object.defineProperties(  
  {},  {    bar: {      get: function() {        return this._bar;      },      set: function(value) {        this._bar = value;      },      configurable: true,      enumerable: true,    },  });  
```
## Installation[​](_docs_babel-plugin-transform-property-mutators.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-property-mutators.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-property-mutators.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-property-mutators.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-property-mutators script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-property-mutators.md#via-node-api)
...
#### _docs_babel-plugin-transform-proto-to-assign.md

> Source: https://babeljs.io/docs/babel-plugin-transform-proto-to-assign
> Scraped: 3/31/2025, 2:29:32 PM

## Detail[​](_docs_babel-plugin-transform-proto-to-assign.md#detail)
...
## Example[​](_docs_babel-plugin-transform-proto-to-assign.md#example)
...
_defaults(bar, foo);  
```
## Installation[​](_docs_babel-plugin-transform-proto-to-assign.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-proto-to-assign.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-proto-to-assign.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-proto-to-assign.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-proto-to-assign script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-proto-to-assign.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-proto-to-assign"],});  
```
## References[​](_docs_babel-plugin-transform-proto-to-assign.md#references)
...
#### _docs_babel-plugin-transform-react-constant-elements.md

> Source: https://babeljs.io/docs/babel-plugin-transform-react-constant-elements
> Scraped: 3/31/2025, 2:29:26 PM
...
## Example[​](_docs_babel-plugin-transform-react-constant-elements.md#example)
...
const WithChildren = (props) => {  
  return <div className={props.className}>    <hr />  </div>;}  
```
**Out**
...
const WithChildren = (props) => {  
  return <div className={props.className}>    {_hr2 || (_hr2 = <hr />)}  </div>;}  
```
**Deopts**   **Spread Operator**   **Refs**
...
<div style={{ width: 100 }} />  
```
## Installation[​](_docs_babel-plugin-transform-react-constant-elements.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-react-constant-elements.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-react-constant-elements.md#with-a-configuration-file-recommended)
...
```
## Options[​](_docs_babel-plugin-transform-react-constant-elements.md#options)

### `allowMutablePropsOnTags`[​](_docs_babel-plugin-transform-react-constant-elements.md#allowmutablepropsontags)
...
```
{  
  "plugins": [    [      "@babel/plugin-transform-react-constant-elements",      { "allowMutablePropsOnTags": ["FormattedMessage"] }    ]  ]}  
```
tip

You can read more about configuring plugin options [here](_docs_en_plugins.md#plugin-options)

### Via CLI[​](_docs_babel-plugin-transform-react-constant-elements.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-react-constant-elements script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-react-constant-elements.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-react-constant-elements"],});  
```
## References[​](_docs_babel-plugin-transform-react-constant-elements.md#references)
...
#### _docs_babel-plugin-transform-react-display-name.md

> Source: https://babeljs.io/docs/babel-plugin-transform-react-display-name
> Scraped: 3/31/2025, 2:29:28 PM

info

This plugin is included in `@babel/preset-react`

## Example[​](_docs_babel-plugin-transform-react-display-name.md#example)
...
var foo = React.createClass({  
  displayName: "foo",}); // React <= 15  
var bar = createReactClass({  
  displayName: "bar",}); // React 16+  
```
## Installation[​](_docs_babel-plugin-transform-react-display-name.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-react-display-name.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-react-display-name.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-react-display-name.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-react-display-name script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-react-display-name.md#via-node-api)
...
#### _docs_babel-plugin-transform-react-inline-elements.md

> Source: https://babeljs.io/docs/babel-plugin-transform-react-inline-elements
> Scraped: 3/31/2025, 2:29:28 PM

## Note[​](_docs_babel-plugin-transform-react-inline-elements.md#note)
...
## Example[​](_docs_babel-plugin-transform-react-inline-elements.md#example)
...
/** Instead of * * React.createElement(Baz, { *   foo: "bar", *   key: "1", * }); */
```
**Deopt**
...
<Foo {...bar} />  
```
## Installation[​](_docs_babel-plugin-transform-react-inline-elements.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-react-inline-elements.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-react-inline-elements.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-react-inline-elements.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-react-inline-elements script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-react-inline-elements.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-react-inline-elements"],});  
```
## References[​](_docs_babel-plugin-transform-react-inline-elements.md#references)
*   [\[facebook/react#3228\] Optimizing Compiler: Inline React Elements](https://github.com/facebook/react/issues/3228)

#### _docs_babel-plugin-transform-react-jsx-compat.md

> Source: https://babeljs.io/docs/babel-plugin-transform-react-jsx-compat
> Scraped: 3/31/2025, 2:29:28 PM

## Example[​](_docs_babel-plugin-transform-react-jsx-compat.md#example)
...
```
var profile = (  
  <div>    <img src="avatar.png" class="profile" />    <h3>{[user.firstName, user.lastName].join(" ")}</h3>  </div>);  
```
**Out**
...
var profile = React.DOM.div(  
  null,  React.DOM.img({ src: "avatar.png", class: "profile" }),  React.DOM.h3(null, [user.firstName, user.lastName].join(" ")));  
```
## Installation[​](_docs_babel-plugin-transform-react-jsx-compat.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-react-jsx-compat.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-react-jsx-compat.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-react-jsx-compat.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-react-jsx-compat script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-react-jsx-compat.md#via-node-api)
...
#### _docs_babel-plugin-transform-react-jsx-self.md

> Source: https://babeljs.io/docs/babel-plugin-transform-react-jsx-self
> Scraped: 3/31/2025, 2:29:28 PM
...
## Example[​](_docs_babel-plugin-transform-react-jsx-self.md#example)

**In***Out**
```
<sometag __self={this} />  
```
## Installation[​](_docs_babel-plugin-transform-react-jsx-self.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-react-jsx-self.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-react-jsx-self.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-react-jsx-self.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-react-jsx-self script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-react-jsx-self.md#via-node-api)
...
#### _docs_babel-plugin-transform-react-jsx-source.md

> Source: https://babeljs.io/docs/babel-plugin-transform-react-jsx-source
> Scraped: 3/31/2025, 2:29:30 PM
...
## Example[​](_docs_babel-plugin-transform-react-jsx-source.md#example)
...
## Installation[​](_docs_babel-plugin-transform-react-jsx-source.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-react-jsx-source.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-react-jsx-source.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-react-jsx-source.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-react-jsx-source script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-react-jsx-source.md#via-node-api)
...
#### _docs_babel-plugin-transform-regenerator.md

> Source: https://babeljs.io/docs/babel-plugin-transform-regenerator
> Scraped: 3/31/2025, 2:29:33 PM
...
## Example[​](_docs_babel-plugin-transform-regenerator.md#example)
...
function a() {  
  return regeneratorRuntime.wrap(    function a$(_context) {      while (1) {        switch ((_context.prev = _context.next)) {          case 0:            _context.next = 2;            return 1;  
          case 2:          case "end":            return _context.stop();        }      }    },    _marked[0],    this  );}  
```
## Installation[​](_docs_babel-plugin-transform-regenerator.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-regenerator.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-regenerator.md#with-a-configuration-file-recommended)
...
```
{  
  "plugins": [    [      "@babel/plugin-transform-regenerator",      {        "asyncGenerators": false,        "generators": false,        "async": false      }    ]  ]}  
```
### Via CLI[​](_docs_babel-plugin-transform-regenerator.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-regenerator script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-regenerator.md#via-node-api)
...
#### _docs_babel-plugin-transform-regexp-modifiers.md

> Source: https://babeljs.io/docs/babel-plugin-transform-regexp-modifiers
> Scraped: 3/31/2025, 2:29:04 PM
...
## Example[​](_docs_babel-plugin-transform-regexp-modifiers.md#example)

### `i` modifier[​](_docs_babel-plugin-transform-regexp-modifiers.md#i-modifier)
...
const regex = /(?:[Aa])a/  
```
### `m` modifier[​](_docs_babel-plugin-transform-regexp-modifiers.md#m-modifier)
...
const regex = /(?:(?:^|(?<=[\n\r\u2028\u2029]))a)a/  
```
### `s` modifier[​](_docs_babel-plugin-transform-regexp-modifiers.md#s-modifier)
...
const regex = /(?:[\s\S])./;  
```
### Multiple modifiers[​](_docs_babel-plugin-transform-regexp-modifiers.md#multiple-modifiers)
...
## Installation[​](_docs_babel-plugin-transform-regexp-modifiers.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-regexp-modifiers.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-regexp-modifiers.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-regexp-modifiers.md#via-cli)

Shell
```
babel --plugins @babel/@babel/plugin-transform-regexp-modifiers script.js  
```
### Via Node.js API[​](_docs_babel-plugin-transform-regexp-modifiers.md#via-nodejs-api)
...
require("@babel/core").transformSync(code, {  
  plugins: ["@babel/plugin-transform-regexp-modifiers"],});  
```
## References[​](_docs_babel-plugin-transform-regexp-modifiers.md#references)
*   [Proposal: Regular Expression Pattern Modifiers for ECMAScript](https://github.com/tc39/transform-regexp-modifiers)

#### _docs_babel-plugin-transform-reserved-words.md

> Source: https://babeljs.io/docs/babel-plugin-transform-reserved-words
> Scraped: 3/31/2025, 2:29:23 PM
...
## Example[​](_docs_babel-plugin-transform-reserved-words.md#example)
...
var x = _abstract + 1;  
```
## Installation[​](_docs_babel-plugin-transform-reserved-words.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-reserved-words.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-reserved-words.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-reserved-words.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-reserved-words script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-reserved-words.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-reserved-words"],});  
```
## References[​](_docs_babel-plugin-transform-reserved-words.md#references)
...
#### _docs_babel-plugin-transform-shorthand-properties.md

> Source: https://babeljs.io/docs/babel-plugin-transform-shorthand-properties
> Scraped: 3/31/2025, 2:29:19 PM
...
## Example[​](_docs_babel-plugin-transform-shorthand-properties.md#example)
...
```
## Installation[​](_docs_babel-plugin-transform-shorthand-properties.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-shorthand-properties.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-shorthand-properties.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-shorthand-properties.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-shorthand-properties script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-shorthand-properties.md#via-node-api)
...
#### _docs_babel-plugin-transform-spread.md

> Source: https://babeljs.io/docs/babel-plugin-transform-spread
> Scraped: 3/31/2025, 2:29:21 PM

info

This plugin is included in `@babel/preset-env`

## Example[​](_docs_babel-plugin-transform-spread.md#example)
...
```
## Installation[​](_docs_babel-plugin-transform-spread.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-spread.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-spread.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-spread.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-spread script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-spread.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-spread"],});  
```
## Options[​](_docs_babel-plugin-transform-spread.md#options)

### `loose`[​](_docs_babel-plugin-transform-spread.md#loose)
...
### `allowArrayLike`[​](_docs_babel-plugin-transform-spread.md#allowarraylike)
...
## References[​](_docs_babel-plugin-transform-spread.md#references)
*   [MDN: Spread syntax](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax)

#### _docs_babel-plugin-transform-sticky-regex.md

> Source: https://babeljs.io/docs/babel-plugin-transform-sticky-regex
> Scraped: 3/31/2025, 2:29:21 PM
...
## Examples[​](_docs_babel-plugin-transform-sticky-regex.md#examples)
...
```
## Installation[​](_docs_babel-plugin-transform-sticky-regex.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-sticky-regex.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-sticky-regex.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-sticky-regex.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-sticky-regex script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-sticky-regex.md#via-node-api)
...
#### _docs_babel-plugin-transform-strict-mode.md

> Source: https://babeljs.io/docs/babel-plugin-transform-strict-mode
> Scraped: 3/31/2025, 2:29:33 PM
...
## Example[​](_docs_babel-plugin-transform-strict-mode.md#example)

**In***Out**

## Installation[​](_docs_babel-plugin-transform-strict-mode.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-strict-mode.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-strict-mode.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-strict-mode.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-strict-mode script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-strict-mode.md#via-node-api)
...
#### _docs_babel-plugin-transform-template-literals.md

> Source: https://babeljs.io/docs/babel-plugin-transform-template-literals
> Scraped: 3/31/2025, 2:29:21 PM
...
## Example[​](_docs_babel-plugin-transform-template-literals.md#example)

**In***Out**

## Installation[​](_docs_babel-plugin-transform-template-literals.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-template-literals.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-template-literals.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-template-literals.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-template-literals script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-template-literals.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  plugins: ["@babel/plugin-transform-template-literals"],});  
```
## Options[​](_docs_babel-plugin-transform-template-literals.md#options)

### `loose`[​](_docs_babel-plugin-transform-template-literals.md#loose)
...
#### _docs_babel-plugin-transform-typeof-symbol.md

> Source: https://babeljs.io/docs/babel-plugin-transform-typeof-symbol
> Scraped: 3/31/2025, 2:29:22 PM

info

This plugin is included in `@babel/preset-env`

## Example[​](_docs_babel-plugin-transform-typeof-symbol.md#example)
...
```
## Installation[​](_docs_babel-plugin-transform-typeof-symbol.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-typeof-symbol.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-typeof-symbol.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-typeof-symbol.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-typeof-symbol script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-typeof-symbol.md#via-node-api)
...
#### _docs_babel-plugin-transform-unicode-escapes.md

> Source: https://babeljs.io/docs/babel-plugin-transform-unicode-escapes
> Scraped: 3/31/2025, 2:29:21 PM
...
## Example[​](_docs_babel-plugin-transform-unicode-escapes.md#example)
...
```
## Installation[​](_docs_babel-plugin-transform-unicode-escapes.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-unicode-escapes.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-unicode-escapes.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-unicode-escapes.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-unicode-escapes  
```
### Via Node API[​](_docs_babel-plugin-transform-unicode-escapes.md#via-node-api)
...
#### _docs_babel-plugin-transform-unicode-property-regex.md

> Source: https://babeljs.io/docs/babel-plugin-transform-unicode-property-regex
> Scraped: 3/31/2025, 2:29:13 PM
...
## Installation[​](_docs_babel-plugin-transform-unicode-property-regex.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-unicode-property-regex.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-unicode-property-regex.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-unicode-property-regex.md#via-cli)

Shell
```
babel --plugins @babel/@babel/plugin-transform-unicode-property-regex script.js  
```
### Via Node.js API[​](_docs_babel-plugin-transform-unicode-property-regex.md#via-nodejs-api)
...
```
## Options[​](_docs_babel-plugin-transform-unicode-property-regex.md#options)
...
#### _docs_babel-plugin-transform-unicode-regex.md

> Source: https://babeljs.io/docs/babel-plugin-transform-unicode-regex
> Scraped: 3/31/2025, 2:29:24 PM
...
## Example[​](_docs_babel-plugin-transform-unicode-regex.md#example)
...
var match = string.match(  
  /foo((?:[\0-\t\x0B\f\x0E-\u2027\u202A-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]))bar/);  
```
## Installation[​](_docs_babel-plugin-transform-unicode-regex.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-unicode-regex.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-unicode-regex.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-unicode-regex.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-unicode-regex script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-unicode-regex.md#via-node-api)
...
#### _docs_babel-plugin-transform-unicode-sets-regex.md

> Source: https://babeljs.io/docs/babel-plugin-transform-unicode-sets-regex
> Scraped: 3/31/2025, 2:29:06 PM
...
## Example[​](_docs_babel-plugin-transform-unicode-sets-regex.md#example)

### Intersection[​](_docs_babel-plugin-transform-unicode-sets-regex.md#intersection)
...
### Difference[​](_docs_babel-plugin-transform-unicode-sets-regex.md#difference)
...
/[\x85\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/u;  
```
### Property of Strings[​](_docs_babel-plugin-transform-unicode-sets-regex.md#property-of-strings)
...
```
## Installation[​](_docs_babel-plugin-transform-unicode-sets-regex.md#installation)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-plugin-transform-unicode-sets-regex.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-plugin-transform-unicode-sets-regex.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-plugin-transform-unicode-sets-regex.md#via-cli)

Shell
```
babel --plugins @babel/plugin-transform-unicode-sets-regex script.js  
```
### Via Node API[​](_docs_babel-plugin-transform-unicode-sets-regex.md#via-node-api)
...
#### _docs_babel-preset-stage-0.md

> Source: https://babeljs.io/docs/babel-preset-stage-0
> Scraped: 3/31/2025, 2:28:58 PM

danger

As of Babel v7, all the stage presets have been deprecated. Check [the blog post](_blog_2018_07_27_removing-babels-stage-presets.md) for more information.
...
## Install[​](_docs_babel-preset-stage-0.md#install)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-preset-stage-0.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-preset-stage-0.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-preset-stage-0.md#via-cli)

Shell
```
babel script.js --presets @babel/preset-stage-0  
```
### Via Node API[​](_docs_babel-preset-stage-0.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  presets: ["@babel/preset-stage-0"]});  
```
## Options[​](_docs_babel-preset-stage-0.md#options)

### `loose`[​](_docs_babel-preset-stage-0.md#loose)

`boolean`, defaults to `false`.

Enable "loose" transformations for any plugins in this preset that allow them.

### `useBuiltIns`[​](_docs_babel-preset-stage-0.md#usebuiltins)

`boolean`, defaults to `false`.

Will use the native built-in instead of trying to polyfill behavior for any plugins that require one.

### `decoratorsLegacy`[​](_docs_babel-preset-stage-0.md#decoratorslegacy)
...
#### _docs_babel-preset-stage-1.md

> Source: https://babeljs.io/docs/babel-preset-stage-1
> Scraped: 3/31/2025, 2:28:58 PM
...
## Install[​](_docs_babel-preset-stage-1.md#install)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-preset-stage-1.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-preset-stage-1.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-preset-stage-1.md#via-cli)

Shell
```
babel script.js --presets @babel/preset-stage-1  
```
### Via Node API[​](_docs_babel-preset-stage-1.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  presets: ["@babel/preset-stage-1"]});  
```
## Options[​](_docs_babel-preset-stage-1.md#options)

### `loose`[​](_docs_babel-preset-stage-1.md#loose)

`boolean`, defaults to `false`.

Enable "loose" transformations for any plugins in this preset that allow them.

### `useBuiltIns`[​](_docs_babel-preset-stage-1.md#usebuiltins)

`boolean`, defaults to `false`.

Will use the native built-in instead of trying to polyfill behavior for any plugins that require one.

### `decoratorsLegacy`[​](_docs_babel-preset-stage-1.md#decoratorslegacy)

`boolean`, defaults to `false`.

Use the legacy (stage 1) decorators syntax and behavior.

## References[​](_docs_babel-preset-stage-1.md#references)
*   Chapter "[The TC39 process for ECMAScript features](http://exploringjs.com/es2016-es2017/ch_tc39-process.html)" in "Exploring ES2016 and ES2017" by Axel Rauschmayer

#### _docs_babel-preset-stage-2.md

> Source: https://babeljs.io/docs/babel-preset-stage-2
> Scraped: 3/31/2025, 2:29:00 PM
...
## Install[​](_docs_babel-preset-stage-2.md#install)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-preset-stage-2.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-preset-stage-2.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-preset-stage-2.md#via-cli)

Shell
```
babel script.js --presets @babel/preset-stage-2  
```
### Via Node API[​](_docs_babel-preset-stage-2.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  presets: ["@babel/preset-stage-2"]});  
```
## Options[​](_docs_babel-preset-stage-2.md#options)

### `loose`[​](_docs_babel-preset-stage-2.md#loose)

`boolean`, defaults to `false`.

Enable "loose" transformations for any plugins in this preset that allow them.

### `useBuiltIns`[​](_docs_babel-preset-stage-2.md#usebuiltins)

`boolean`, defaults to `false`.

Will use the native built-in instead of trying to polyfill behavior for any plugins that require one.

### `decoratorsLegacy`[​](_docs_babel-preset-stage-2.md#decoratorslegacy)
...
## References[​](_docs_babel-preset-stage-2.md#references)
*   Chapter "[The TC39 process for ECMAScript features](http://exploringjs.com/es2016-es2017/ch_tc39-process.html)" in "Exploring ES2016 and ES2017" by Axel Rauschmayer

#### _docs_babel-preset-stage-3.md

> Source: https://babeljs.io/docs/babel-preset-stage-3
> Scraped: 3/31/2025, 2:29:00 PM
...
## Install[​](_docs_babel-preset-stage-3.md#install)
*   npm
*   Yarn
*   pnpm
```
...
```
## Usage[​](_docs_babel-preset-stage-3.md#usage)

### With a configuration file (Recommended)[​](_docs_babel-preset-stage-3.md#with-a-configuration-file-recommended)
...
```
### Via CLI[​](_docs_babel-preset-stage-3.md#via-cli)

Shell
```
babel script.js --presets @babel/preset-stage-3  
```
### Via Node API[​](_docs_babel-preset-stage-3.md#via-node-api)
...
require("@babel/core").transformSync("code", {  
  presets: ["@babel/preset-stage-3"]});  
```
## Options[​](_docs_babel-preset-stage-3.md#options)

### `loose`[​](_docs_babel-preset-stage-3.md#loose)

`boolean`, defaults to `false`.

Enable "loose" transformations for any plugins in this preset that allow them.

### `useBuiltIns`[​](_docs_babel-preset-stage-3.md#usebuiltins)
...
## References[​](_docs_babel-preset-stage-3.md#references)
*   Chapter "[The TC39 process for ECMAScript features](http://exploringjs.com/es2016-es2017/ch_tc39-process.html)" in "Exploring ES2016 and ES2017" by Axel Rauschmayer
...
#### _docs_babel-runtime-corejs2.md

> Source: https://babeljs.io/docs/babel-runtime-corejs2
> Scraped: 3/31/2025, 2:28:58 PM
...
## Installation[​](_docs_babel-runtime-corejs2.md#installation)
*   npm
*   Yarn
*   pnpm
```
npm install --save @babel/runtime-corejs2  
```
> See also: [`@babel/runtime`](_docs_babel-runtime.md).

## Usage[​](_docs_babel-runtime-corejs2.md#usage)

This is meant to be used as a runtime `dependency` along with the Babel plugin [`@babel/plugin-transform-runtime`](_docs_babel-plugin-transform-runtime.md). Please check out the documentation in that package for usage.

## Why[​](_docs_babel-runtime-corejs2.md#why)
...
## Difference from `@babel/runtime`[​](_docs_babel-runtime-corejs2.md#difference-from-babelruntime)
...
#### _docs_babel-runtime.md

> Source: https://babeljs.io/docs/babel-runtime
> Scraped: 3/31/2025, 2:28:57 PM

`@babel/runtime` is a library that contains Babel modular runtime helpers.

## Installation[​](_docs_babel-runtime.md#installation)
*   npm
*   Yarn
*   pnpm
```
npm install --save @babel/runtime  
```
> See also: [`@babel/runtime-corejs2`](_docs_babel-runtime-corejs2.md).

## Usage[​](_docs_babel-runtime.md#usage)

This is meant to be used as a runtime `dependency` along with the Babel plugin [`@babel/plugin-transform-runtime`](_docs_babel-plugin-transform-runtime.md). Please check out the documentation in that package for usage.

## Why[​](_docs_babel-runtime.md#why)
...
#### _docs_babel-standalone.md

> Source: https://babeljs.io/docs/babel-standalone
> Scraped: 3/31/2025, 2:28:58 PM

`@babel/standalone` provides a standalone build of Babel for use in browsers and other non-Node.js environments.

## When (not) to use @babel/standalone[​](_docs_babel-standalone.md#when-not-to-use-babelstandalone)
...
*   Sites that compile user-provided JavaScript in real-time, like [JSFiddle](https://jsfiddle.net/), [JS Bin](https://jsbin.com/), the [REPL on the Babel site](_repl_.md), [JSitor](https://jsitor.com/), etc.
...
## Installation[​](_docs_babel-standalone.md#installation)
...
<script type="text/babel">  
  const getMessage = () => "Hello World";  document.getElementById("output").innerHTML = getMessage();</script>  
```
### Attributes[​](_docs_babel-standalone.md#attributes)

#### `data-type`[​](_docs_babel-standalone.md#data-type)
...
```
#### `data-presets`[​](_docs_babel-standalone.md#data-presets)

Use the `data-presets` attributes to enable builtin Babel presets. Multiple values are comma separated:
```
<script type="text/babel" data-presets="env,react">  
```
Most popular presets are: [`env`](_docs_babel-preset-env.md), [`react`](_docs_babel-preset-react.md), [`typescript`](_docs_babel-preset-typescript.md), [`flow`](_docs_babel-preset-flow.md). You can also use `Babel.availablePresets` to query available presets.

If you want to pass additional options, refer to the [custom presets](_docs_babel-standalone.md#custom-presets-passing-options-to-built-in-presetsplugins) section.

#### `data-plugins`[​](_docs_babel-standalone.md#data-plugins)
...
If you want to add custom plugins, refer to the [custom plugins](_docs_babel-standalone.md#custom-plugins) section.

#### `src`[​](_docs_babel-standalone.md#src)

Loading external scripts via `src` attribute is supported too:
```
<script type="text/babel" src="foo.js"></script>  
```
#### `async`[​](_docs_babel-standalone.md#async)

You can also set the `async` attribute for external scripts.
```
<script type="text/babel" src="foo.js" async></script>  
```
## API[​](_docs_babel-standalone.md#api)

Load `babel.js` or `babel.min.js` in your environment. This will expose [Babel's API](_docs_usage_api_.md) in a `Babel` object:
...
```
Note that [config files](_docs_config-files.md) don't work in `@babel/standalone`, as no file system access is available. The presets and/or plugins to use **must** be specified in the options passed to `Babel.transform`.

### Internal packages[​](_docs_babel-standalone.md#internal-packages)
...
## Customization[​](_docs_babel-standalone.md#customization)

### custom plugins[​](_docs_babel-standalone.md#custom-plugins)
...
function lolizer() {  
  return {    visitor: {      Identifier(path) {        path.node.name = "LOL";      },    },  };}  
...
```
### custom presets: passing options to built-in presets/plugins[​](_docs_babel-standalone.md#custom-presets-passing-options-to-built-in-presetsplugins)
...
Babel.registerPreset("env-plus", {  
  presets: [[Babel.availablePresets["env"], { loose: true }]],  plugins: [    [      Babel.availablePlugins["proposal-decorators"],      { version: "2023-01" },    ],  ],});  
```
...
#### _docs_babel-template.md

> Source: https://babeljs.io/docs/babel-template
> Scraped: 3/31/2025, 2:29:39 PM

In computer science, this is known as an implementation of quasiquotes.

## Install[​](_docs_babel-template.md#install)
*   npm
*   Yarn
*   pnpm
```
...
```
## String Usage[​](_docs_babel-template.md#string-usage)
...
You can use two different kinds of placeholders: syntactic placeholders (e.g. `%%name%%`) or identifier placeholders (e.g. `NAME`). `@babel/template` supports both those approaches by default, but they can't be mixed. If you need to be explicit about what syntax you are using, you can use the [`syntacticPlaceholders`](_docs_babel-template.md#syntacticplaceholders) option.
...
const ast = buildRequire({  
  importName: t.identifier("myModule"),  source: t.stringLiteral("my-module"),});  
...
const ast = buildRequire({  
  IMPORT_NAME: t.identifier("myModule"),  SOURCE: t.stringLiteral("my-module"),});  
```
Output:
...
```
### `.ast`[​](_docs_babel-template.md#ast)
...
## Template Literal Usage[​](_docs_babel-template.md#template-literal-usage)
...
### `.ast`[​](_docs_babel-template.md#ast-1)
...
## AST results[​](_docs_babel-template.md#ast-results)
...
### `template.statement`[​](_docs_babel-template.md#templatestatement)
...
### `template.statements`[​](_docs_babel-template.md#templatestatements)

`template.statements("foo;foo;")()` returns an array of statement nodes.

### `template.expression`[​](_docs_babel-template.md#templateexpression)

`template.expression("foo")()` returns the expression node.

### `template.program`[​](_docs_babel-template.md#templateprogram)

`template.program("foo;")()` returns the `Program` node for the template.

## API[​](_docs_babel-template.md#api)

### `template(code, [opts])`[​](_docs_babel-template.md#templatecode-opts)

#### code[​](_docs_babel-template.md#code)

Type: `string`

#### options[​](_docs_babel-template.md#options)

`@babel/template` accepts all of the options from [Babel Parser](_docs_babel-parser.md#options), and specifies some defaults of its own:
*   `allowReturnOutsideFunction` is set to `true` by default.
*   `allowSuperOutsideMethod` is set to `true` by default.
*   `sourceType` is set to `module` by default.

#### syntacticPlaceholders[​](_docs_babel-template.md#syntacticplaceholders)
...
##### placeholderWhitelist[​](_docs_babel-template.md#placeholderwhitelist)
...
##### placeholderPattern[​](_docs_babel-template.md#placeholderpattern)
...
#### Return value[​](_docs_babel-template.md#return-value)
...
#### _docs_v7-migration-api.md

> Source: https://babeljs.io/docs/v7-migration-api
> Scraped: 3/31/2025, 2:28:56 PM

Refer users to this document when upgrading to Babel 7.

> Also check out the [v7-migration guide](_docs_v7-migration.md) for other user-level changes.

## All Babel packages[​](_docs_v7-migration-api.md#all-babel-packages)

### NodeJS support[​](_docs_v7-migration-api.md#nodejs-support)
...
### Export changes[​](_docs_v7-migration-api.md#export-changes)
...
## `@babel/core`[​](_docs_v7-migration-api.md#babelcore)
...
```
### Config changes[​](_docs_v7-migration-api.md#config-changes)
...
Check the `babel.config.js` docs for more info: [project-wide configuration](_docs_config-files.md#project-wide-configuration)

This file combined with the new [`overrides`](_docs_options.md#overrides) property and `env` lets you have a single config file that can work for all the files in a project vs. multiple config files per folder.
...
## Asserting Babel version [#7450](https://github.com/babel/babel/pull/7450)[​](_docs_v7-migration-api.md#asserting-babel-version-7450)
...
export default declare(api => {  
  api.assertVersion(7);  // ...});  
```
## Babel plugins/presets[​](_docs_v7-migration-api.md#babel-pluginspresets)
...
```
## `babel-parser` (known as Babylon)[​](_docs_v7-migration-api.md#babel-parser-known-as-babylon)
...
```
babelParser.parse(code, {  
  plugins: [    "asyncGenerators",    "classProperties",    "decorators",    "doExpressions",    "dynamicImport",    "exportExtensions",    "flow",    "functionBind",    "functionSent",    "jsx",    "objectRestSpread",  ],});  
```
See Babylon's [plugin options](_docs_babel-parser.md#plugins).
...
## `@babel/traverse`[​](_docs_v7-migration-api.md#babeltraverse)
...
```
## AST changes[​](_docs_v7-migration-api.md#ast-changes)

### Add `InterpreterDirective` Node [#7928](https://github.com/babel/babel/pull/7928)[​](_docs_v7-migration-api.md#add-interpreterdirective-node-7928)
...
```
### JSX\* and TS\* node builders (from @babel/types package) renamed[​](_docs_v7-migration-api.md#jsx-and-ts-node-builders-from-babeltypes-package-renamed)
...
### `.expression` field removed from `ArrowFunctionExpression`[​](_docs_v7-migration-api.md#expression-field-removed-from-arrowfunctionexpression)
...
```
  return {    visitor: {      ArrowFunctionExpression({ node }) {-       if (node.expression) {  
+       if (node.body.type !== "BlockStatement") {  
          // () => foo;        }      }    }  };
```
### Tokens removed[​](_docs_v7-migration-api.md#tokens-removed)
...
```
export default function() {  
  return {    manipulateOptions(opts, parserOpts) {      parserOpts.tokens = true;    },    ...  };}  
```
### Renamed[​](_docs_v7-migration-api.md#renamed)
...
[#322](https://github.com/babel/babylon/pull/322)
...
```
### Replaced[​](_docs_v7-migration-api.md#replaced)
...
```
type VarianceNode = {  
  type: "Variance",  kind: "plus" | "minus",};  
```
```
 return {   Property({ node }) {-    if (node.variance === "plus") {  
+    if (node.variance.kind === "plus") {  
       ...-    } else if (node.variance === "minus") {  
+    } else if (node.variance.kind === "minus") {  
       ...     }   } };
```
### Location changes[​](_docs_v7-migration-api.md#location-changes)
...
```
```
 {   "type": "ObjectTypeIndexer",   "start": 9,-  "end": 29,  
+  "end": 28,  
   "loc": {     "start": {       "line": 1,       "column": 9,     },     "end": {       "line": 1,-      "column": 29  
+      "column": 28  
     }   } }
```
### Removal[​](_docs_v7-migration-api.md#removal)

#### ForAwaitStatement[​](_docs_v7-migration-api.md#forawaitstatement)
...
```
 interface ForOfStatement <: ForInStatement {   type: "ForOfStatement";+  await: boolean;  
 }
```
```
 return {-  ForAwaitStatement(path) {  
-    ...  
+  ForOfStatement(path) {  
+    if (path.node.await) {  
+      ...  
...
```
#### RestProperty & SpreadProperty[​](_docs_v7-migration-api.md#restproperty--spreadproperty)
